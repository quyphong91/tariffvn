...
export const chapterNotesData: ChapterNote[] = [
  {
    ...
    notesVi: [
      ...
      (a) Cá và động vật giáp xác, động vật thân mềm và động vật thủy sinh không xương sống khác (nhóm 03.01, 03.06, 03.07 hoặc 03.08); 
  ...
  },
  {
    chapter: 84,
    section: 16,
    sectionTitleVi: "MÁY VÀ CÁC TRANG THIẾT BỊ CƠ KHÍ; THIẾT BỊ ĐIỆN; CÁC BỘ PHẬN CỦA CHÚNG; THIẾT BỊ GHI VÀ TÁI TẠO ÂM THANH, THIẾT BỊ GHI VÀ TÁI TẠO HÌNH ẢNH, ÂM THANH TRUYỀN HÌNH VÀ CÁC BỘ PHẬN VÀ PHỤ KIỆN CỦA CÁC THIẾT BỊ TRÊN",
    sectionTitleEn: "MACHINERY AND MECHANICAL APPLIANCES; ELECTRICAL EQUIPMENT; PARTS THEREOF; SOUND RECORDERS AND REPRODUCERS, TELEVISION IMAGE AND SOUND RECORDERS AND REPRODUCERS, AND PARTS AND ACCESSORIES OF SUCH ARTICLES",
    titleVi: "Lò phản ứng hạt nhân, nồi hơi, máy và thiết bị cơ khí; các bộ phận của chúng",
    titleEn: "Nuclear reactors, boilers, machinery and mechanical appliances; parts thereof",
    notesVi: [
      "1. Chương này không bao gồm: (a) Các sản phẩm thuộc nhóm 73.21 hoặc 73.22 hoặc các sản phẩm tương tự bằng kim loại cơ bản khác; (b) Máy hút bụi thuộc nhóm 85.08; (c) Thiết bị cơ điện gia dụng thuộc nhóm 85.09; camera kỹ thuật số thuộc nhóm 85.25; (d) Bộ tản nhiệt cho các hàng hóa của Phần XVII; (e) Máy quét sàn cơ khí thao tác bằng tay, không có động cơ (nhóm 96.03).",
      "2. Theo nội dung của Chú giải 3 Phần XVI và Chú giải 11 của Chương này, máy móc hoặc thiết bị thỏa mãn mô tả của một hoặc nhiều nhóm từ 84.01 đến 84.24, hoặc nhóm 84.86 và đồng thời thỏa mãn mô tả của một hoặc nhiều nhóm từ 84.25 đến 84.80 thì được phân loại vào một nhóm thích hợp trong số các nhóm từ 84.01 đến 84.24 hoặc 84.86.",
      "3. Nhóm 84.57 chỉ áp dụng cho máy công cụ để gia công kim loại, trừ máy tiện (kể cả trung tâm gia công).",
      "4. Theo mục đích của nhóm 84.71, khái niệm \"máy xử lý dữ liệu tự động\" là máy có khả năng: (i) Lưu trữ chương trình xử lý; (ii) Lập chương trình tùy theo yêu cầu của người sử dụng; (iii) Thực hiện các phép tính số học tùy theo yêu cầu; (iv) Thực hiện một chương trình xử lý đòi hỏi máy phải biến đổi quy trình thực hiện."
    ],
    notesEn: [
      "1. This Chapter does not cover: (a) Articles of heading 73.21 or 73.22 or similar articles of other base metals; (b) Vacuum cleaners of heading 85.08; (c) Electro-mechanical domestic appliances of heading 85.09; digital cameras of heading 85.25; (d) Radiators for the articles of Section XVII; (e) Hand-operated mechanical floor sweepers, not motorised (heading 96.03).",
      "2. Subject to the operation of Note 3 to Section XVI and subject to Note 11 to this Chapter, a machine or appliance which answers to a description in one or more of the headings 84.01 to 84.24, or heading 84.86 and at the same time to a description in one or more of the headings 84.25 to 84.80 is to be classified under the appropriate heading of the former group or under heading 84.86.",
      "3. Heading 84.57 applies only to machine-tools for working metal, other than lathes (including turning centres).",
      "4. For the purposes of heading 84.71, the expression \"automatic data processing machines\" means machines capable of: (i) Storing the processing program; (ii) Being freely programmed in accordance with the requirements of the user; (iii) Performing arithmetical computations specified by the user; (iv) Executing, without human intervention, a processing program."
    ],
    generalVi: "Chương này bao gồm tất cả các loại máy móc hoặc thiết bị, bộ phận, dụng cụ và các trang thiết bị cơ khí khác nhau như lò phản ứng hạt nhân, nồi hơi, động cơ, máy bơm, máy nén, máy công cụ, máy văn phòng, máy nông nghiệp và các máy móc thiết bị cơ khí khác.",
    generalEn: "This Chapter covers all mechanical or electrical machinery, plant, equipment, apparatus and appliances and parts thereof, including nuclear reactors, boilers, engines, pumps, compressors, machine-tools, office machines, agricultural machinery and other mechanical machinery and equipment.",
    headings: [
      { code: "84.01", titleVi: "Lò phản ứng hạt nhân; các bộ phận chứa nhiên liệu (cartridges) không bị bức xạ dùng cho lò phản ứng hạt nhân; máy và thiết bị để tách đồng vị", titleEn: "Nuclear reactors; fuel elements (cartridges), non-irradiated, for nuclear reactors; machinery and apparatus for isotopic separation", contentVi: "Nhóm này bao gồm lò phản ứng hạt nhân, các bộ phận chứa nhiên liệu không bị bức xạ dùng cho lò phản ứng hạt nhân, và máy và thiết bị để tách đồng vị như máy quay ly tâm đặc biệt để làm giàu uranium U 235.", contentEn: "This heading covers nuclear reactors, fuel elements (cartridges), non-irradiated, for nuclear reactors, and machinery and apparatus for isotopic separation such as special centrifuges for enriching uranium U 235." },
      { code: "84.02", titleVi: "Nồi hơi tạo ra hơi nước hoặc tạo ra hơi khác; nồi hơi nước quá nhiệt", titleEn: "Steam or other vapour generating boilers; super-heated water boilers", contentVi: "Nhóm này bao gồm các loại thiết bị sản sinh ra hơi nước hoặc hơi khác dùng để vận hành các máy kéo động cơ hoặc các dụng cụ sử dụng hơi nước như nguồn năng lượng chính. Các nồi hơi có thể được đốt nóng bằng nhiên liệu rắn, lỏng hoặc khí ga, hoặc năng lượng điện.", contentEn: "This heading includes apparatus for generating steam or other vapour to operate prime movers or other machines using steam power. Steam boilers may be heated by means of a solid, liquid or gaseous fuel, or by electricity." },
      { code: "84.03", titleVi: "Nồi hơi đun nóng nước trung tâm, trừ loại thuộc nhóm 84.02", titleEn: "Central heating boilers other than those of heading 84.02", contentVi: "Nhóm này bao gồm các nồi hơi đun nóng nước trung tâm dùng để sưởi ấm các tòa nhà hoặc cơ sở công nghiệp.", contentEn: "This heading covers central heating boilers used for heating buildings or industrial premises." },
      { code: "84.04", titleVi: "Thiết bị phụ trợ dùng cho nồi hơi thuộc nhóm 84.02 hoặc 84.03; thiết bị ngưng tụ dùng cho bộ phận động lực chạy bằng hơi nước hoặc hơi khác", titleEn: "Auxiliary plant for use with boilers of heading 84.02 or 84.03; condensers for steam or other vapour power units", contentVi: "Nhóm này bao gồm các thiết bị phụ trợ dùng cho nồi hơi như bộ hâm nóng nước, bộ quá nhiệt, bộ lọc muội, bộ khử bụi và thiết bị ngưng tụ hơi nước.", contentEn: "This heading covers auxiliary plant for boilers such as economisers, superheaters, soot removers, gas recoverers and condensers for steam power units." },
      { code: "84.07", titleVi: "Động cơ đốt trong kiểu piston đốt cháy bằng tia lửa điện", titleEn: "Spark-ignition reciprocating or rotary internal combustion piston engines", contentVi: "Nhóm này bao gồm động cơ đốt trong kiểu piston đốt cháy bằng tia lửa điện sử dụng nhiên liệu như xăng, khí đốt hóa lỏng hoặc các nhiên liệu khác.", contentEn: "This heading covers spark-ignition reciprocating or rotary internal combustion piston engines using fuels such as petrol, liquefied petroleum gas or other fuels." }
    ]
  },
  {
    chapter: 85,
    ...
    sectionTitleVi: "MÁY VÀ CÁC TRANG THIẾT BỊ CƠ KHÍ; THIẾT BỊ ĐIỆN; CÁC BỘ PHẬN CỦA CHÚNG; THIẾT BỊ GHI VÀ TÁI TẠO ÂM THANH, THIẾT BỊ GHI VÀ TÁI TẠO HÌNH ẢNH, ÂM THANH TRUYỀN HÌNH VÀ CÁC BỘ PHẬN VÀ PHỤ KIỆN CỦA CÁC THIẾT BỊ TRÊN",
    sectionTitleEn: "MACHINERY AND MECHANICAL APPLIANCES; ELECTRICAL EQUIPMENT; PARTS THEREOF; SOUND RECORDERS AND REPRODUCERS, TELEVISION IMAGE AND SOUND RECORDERS AND REPRODUCERS, AND PARTS AND ACCESSORIES OF SUCH ARTICLES",
    titleVi: "Máy điện và thiết bị điện và các bộ phận của chúng; máy ghi và tái tạo âm thanh, máy ghi và tái tạo hình ảnh và âm thanh truyền hình, bộ phận và phụ kiện của các loại máy trên",
    titleEn: "Electrical machinery and equipment and parts thereof; sound recorders and reproducers, television image and sound recorders and reproducers, and parts and accessories of such articles",
    notesVi: [
      "1. Chương này không bao gồm các sản phẩm đã được đề cập trong Chú giải 1 của Phần XVI.",
      "2. Các nhóm từ 85.01 đến 85.04 không áp dụng cho các loại hàng hóa đã mô tả trong nhóm 85.11, 85.12, 85.40, 85.41 hoặc 85.42.",
      "3. Theo mục đích của nhóm 85.07, khái niệm \"ắc quy điện\" bao gồm cả các loại ắc qui có thành phần phụ trợ đóng góp vào chức năng lưu điện và cấp điện hoặc bảo vệ ắc qui khỏi sự hư hại.",
      "4. Nhóm 85.09 chỉ gồm những máy cơ điện loại thông thường được sử dụng cho mục đích gia dụng như máy đánh bóng sàn, máy nghiền và trộn thực phẩm, và máy ép rau hoặc quả.",
      "5. Theo mục đích của nhóm 85.17, thuật ngữ \"điện thoại thông minh\" có nghĩa là điện thoại dùng cho mạng di động tế bào, được trang bị hệ điều hành di động."
    ],
    notesEn: [
      "1. This Chapter does not cover the products mentioned in Note 1 to Section XVI.",
      "2. Headings 85.01 to 85.04 do not apply to goods described in heading 85.11, 85.12, 85.40, 85.41 or 85.42.",
      "3. For the purposes of heading 85.07, the expression \"electric accumulators\" includes those presented with ancillary components which contribute to the accumulator's function of storing and supplying energy or protect it from damage.",
      "4. Heading 85.09 covers only electro-mechanical machines of a kind commonly used for domestic purposes such as floor polishers, food grinders and mixers, and fruit or vegetable juice extractors.",
      "5. For the purposes of heading 85.17, the term \"smartphones\" means telephones for cellular networks, equipped with a mobile operating system."
    ],
    generalVi: "Chương này bao gồm các máy điện và thiết bị điện như động cơ điện, máy phát điện, máy biến thế, ắc quy, thiết bị điện gia dụng, điện thoại, máy ghi âm, máy ghi hình, camera, đèn điện, dây cáp điện và các thiết bị điện tử khác.",
    generalEn: "This Chapter covers electrical machinery and equipment such as electric motors, generators, transformers, batteries, domestic electrical appliances, telephones, sound recorders, video recorders, cameras, electric lamps, electrical cables and other electronic equipment.",
    headings: [
      { code: "85.01", titleVi: "Động cơ điện và máy phát điện (trừ tổ máy phát điện)", titleEn: "Electric motors and generators (excluding generating sets)", contentVi: "Nhóm này bao gồm động cơ điện (máy biến đổi năng lượng điện thành năng lượng cơ) và máy phát điện (máy biến đổi năng lượng cơ thành năng lượng điện). Các máy phát điện có thể hoạt động bằng tay hoặc đạp chân nhưng thông thường chúng được kéo bằng các nguồn lực sơ cấp.", contentEn: "This heading covers electric motors (machines which convert electrical energy into mechanical energy) and electric generators (machines which convert mechanical energy into electrical energy). Electric generators may be hand- or foot-operated but usually they are driven by prime movers." },
      { code: "85.02", titleVi: "Tổ máy phát điện và máy biến đổi điện quay", titleEn: "Electric generating sets and rotary converters", contentVi: "Thuật ngữ 'các tổ máy phát điện' được áp dụng vào tổ hợp một máy phát điện và bất kỳ máy kéo sơ cấp ngoại trừ động cơ điện như tua-bin thủy lực, tua-bin hơi nước, bánh xe gió, máy hơi nước, động cơ đốt trong.", contentEn: "The expression 'electric generating sets' applies to the combination of an electric generator and any prime mover other than an electric motor, such as hydraulic turbines, steam turbines, wind wheels, steam engines, internal combustion engines." },
      { code: "85.04", titleVi: "Máy biến điện (máy biến áp và máy biến dòng), máy biến đổi điện tĩnh và cuộn cảm", titleEn: "Electrical transformers, static converters and inductors", contentVi: "Các máy biến điện là các thiết bị, không có phần chuyển động, sử dụng hiện tượng cảm ứng để biến đổi dòng điện xoay chiều này thành dòng điện xoay chiều khác ở cấp điện áp, trở kháng khác.", contentEn: "Electrical transformers are apparatus, without moving parts, which by electromagnetic induction transform alternating current of one voltage or impedance into alternating current of another voltage or impedance." },
      { code: "85.07", titleVi: "Ắc quy điện, kể cả tấm vách ngăn của ắc quy, có hoặc không hình chữ nhật (kể cả hình vuông)", titleEn: "Electric accumulators, including separators therefor, whether or not rectangular (including square)", contentVi: "Nhóm này bao gồm ắc quy điện (còn gọi là pin thứ cấp), thiết bị lưu trữ năng lượng điện theo phương pháp điện hóa và cung cấp trở lại dưới dạng dòng điện một chiều.", contentEn: "This heading covers electric accumulators (also known as secondary cells or storage batteries), which are devices for storing electrical energy in electrochemical form and delivering it back as direct current." },
      { code: "85.17", titleVi: "Điện thoại hữu tuyến, kể cả điện thoại thông minh và điện thoại khác dùng cho mạng di động tế bào hoặc mạng không dây khác; các thiết bị khác để truyền hoặc nhận tiếng, hình ảnh hoặc dữ liệu khác", titleEn: "Telephone sets, including smartphones and other telephones for cellular networks or for other wireless networks; other apparatus for the transmission or reception of voice, images or other data", contentVi: "Nhóm này bao gồm điện thoại hữu tuyến, điện thoại thông minh và điện thoại di động, cũng như các thiết bị khác để truyền hoặc nhận tiếng, hình ảnh hoặc dữ liệu khác.", contentEn: "This heading covers telephone sets, including smartphones and mobile phones, as well as other apparatus for the transmission or reception of voice, images or other data." }
    ]
  },
  {
    chapter: 86,
    section: 17,
    sectionTitleVi: "XE CỘ, PHƯƠNG TIỆN BAY, TÀU THUYỀN VÀ CÁC THIẾT BỊ VẬN TẢI LIÊN HỢP",
    sectionTitleEn: "VEHICLES, AIRCRAFT, VESSELS AND ASSOCIATED TRANSPORT EQUIPMENT",
    titleVi: "Đầu máy xe lửa, xe điện và phương tiện di chuyển trên đường sắt hoặc đường tàu điện, và các bộ phận của chúng; bộ phận cố định và ghép nối của đường ray đường sắt hoặc tàu điện và các bộ phận của chúng; thiết bị phát tín hiệu giao thông bằng cơ khí (kể cả cơ điện) các loại",
    titleEn: "Railway or tramway locomotives, rolling-stock and parts thereof; railway or tramway track fixtures and fittings and parts thereof; mechanical (including electro-mechanical) traffic signalling equipment of all kinds",
    notesVi: [
      "1. Chương này không bao gồm: (a) Tà vẹt đường sắt hoặc tàu điện bằng gỗ hoặc bê tông, hoặc các bộ phận khác của đường sắt bằng bê tông (nhóm 44.06 hoặc 68.10); (b) Vật liệu làm đường sắt hoặc tàu điện bằng sắt hoặc thép thuộc nhóm 73.02; (c) Các thiết bị phát tín hiệu điện thuộc nhóm 85.30.",
      "2. Nhóm 86.07 bao gồm: giá chuyển hướng, trục bitxen, trục và bánh xe; hãm và bộ phận của hãm; móc toa và các dụng cụ ghép nối toa khác, bộ đệm giảm chấn.",
      "3. Theo các quy định của Chú giải 1 của Phần XVII, nhóm 86.08 bao gồm: bộ phận cố định và ghép nối của đường ray đường sắt hoặc tàu điện; các thiết bị phát tín hiệu, an toàn hoặc điều khiển giao thông bằng cơ khí."
    ],
    notesEn: [
      "1. This Chapter does not cover: (a) Railway or tramway sleepers of wood or of concrete, or concrete guide-track sections for hovertrains (heading 44.06 or 68.10); (b) Railway or tramway track construction material of iron or steel of heading 73.02; (c) Electrical signalling apparatus of heading 85.30.",
      "2. Heading 86.07 applies to bogies, bissel-bogies, axles and wheels; brake gear and parts thereof; hooks and other coupling devices, buffers and parts thereof.",
      "3. Subject to the provisions of Note 1 to Section XVII, heading 86.08 applies to railway or tramway track fixtures and fittings; mechanical signalling, safety or traffic control equipment."
    ],
    generalVi: "Chương này bao gồm tất cả các phương tiện chạy trên đường ray đường sắt hoặc tàu điện, các bộ phận của chúng, bộ phận cố định và ghép nối của đường ray, và các thiết bị phát tín hiệu giao thông bằng cơ khí.",
    generalEn: "This Chapter covers all railway or tramway rolling-stock, parts thereof, railway or tramway track fixtures and fittings, and mechanical traffic signalling equipment.",
    headings: [
      { code: "86.01", titleVi: "Đầu máy xe lửa chạy bằng nguồn điện bên ngoài hoặc chạy bằng ắc quy điện", titleEn: "Rail locomotives powered from an external source of electricity or by electric accumulators", contentVi: "Nhóm này bao gồm các đầu máy xe lửa chạy bằng nguồn điện từ bên ngoài (thông qua dây cáp điện trên không hoặc ray thứ ba) hoặc chạy bằng ắc quy điện.", contentEn: "This heading covers rail locomotives powered from an external source of electricity (through overhead cables or third rail) or by electric accumulators." },
      { code: "86.02", titleVi: "Đầu máy xe lửa khác; toa tiếp liệu", titleEn: "Other rail locomotives; locomotive tenders", contentVi: "Nhóm này bao gồm đầu máy xe lửa chạy bằng động cơ diesel, động cơ đốt trong hoặc động cơ hơi nước, cũng như toa tiếp liệu chở nước và nhiên liệu cho đầu máy hơi nước.", contentEn: "This heading covers rail locomotives powered by diesel engines, internal combustion engines or steam engines, as well as locomotive tenders carrying water and fuel for steam locomotives." },
      { code: "86.03", titleVi: "Toa xe khách, toa xe hàng và toa xe hành lý, loại tự hành dùng trên đường sắt hoặc đường tàu điện, trừ loại thuộc nhóm 86.04", titleEn: "Self-propelled railway or tramway coaches, vans and trucks, other than those of heading 86.04", contentVi: "Toa xe khách tự hành của đường sắt hoặc đường tàu điện khác với các đầu máy xe lửa vì ngoài việc được trang bị bộ phận sinh công, chúng cũng được thiết kế để chuyên chở hành khách hoặc hàng hóa.", contentEn: "Self-propelled railway or tramway coaches differ from locomotives because, in addition to being equipped with a power unit, they are also designed to carry passengers or freight." },
      { code: "86.04", titleVi: "Xe bảo dưỡng hoặc phục vụ dùng trong đường sắt hoặc đường tàu điện, loại tự hành hoặc không", titleEn: "Railway or tramway maintenance or service vehicles, whether or not self-propelled", contentVi: "Các phương tiện thuộc nhóm này, tự hành hay không tự hành, được thiết kế chủ yếu cho mục đích sử dụng trong việc lắp đặt đường sắt, phục vụ và bảo dưỡng các nền và cấu trúc dọc theo đường ray.", contentEn: "These vehicles, whether self-propelled or not, are designed mainly for use in railway installation, maintenance and servicing of track structures." },
      { code: "86.05", titleVi: "Toa xe chở khách không tự hành dùng cho đường sắt hoặc đường tàu điện; toa xe hành lý, toa xe bưu vụ và toa xe chuyên dùng khác cho đường sắt hoặc đường tàu điện, không tự hành", titleEn: "Railway or tramway passenger coaches, not self-propelled; luggage vans, post office coaches and other special purpose railway or tramway coaches, not self-propelled", contentVi: "Nhóm này bao gồm các toa xe chở khách, toa xe ngủ, toa xe nhà hàng, toa xe hành lý, toa xe bưu vụ, toa xe bệnh viện và các toa xe chuyên dụng khác.", contentEn: "This heading covers passenger coaches, sleeping cars, restaurant cars, luggage vans, post office coaches, ambulance coaches and other special purpose coaches." },
      { code: "86.06", titleVi: "Toa xe hàng và toa goòng dùng trên đường sắt hoặc đường tàu điện, không tự hành", titleEn: "Railway or tramway goods vans and wagons, not self-propelled", contentVi: "Nhóm này bao gồm các phương tiện dùng để chuyên chở hàng hóa trên các mạng đường sắt như toa xe xi téc, toa chở hàng tự dỡ tải, toa có nắp đậy và đóng kín.", contentEn: "This heading covers vehicles for the transport of goods on railway networks such as tank wagons, self-discharging vans and wagons, covered and closed wagons." },
      { code: "86.07", titleVi: "Các bộ phận của đầu máy hoặc của phương tiện di chuyển trên đường sắt hoặc đường tàu điện", titleEn: "Parts of railway or tramway locomotives or rolling-stock", contentVi: "Nhóm này bao gồm các bộ phận của đầu máy hoặc của phương tiện di chuyển trên đường sắt như giá chuyển hướng, trục, bánh xe, hộp trục, thiết bị phanh, bộ đệm, móc toa và các bộ phận ghép nối.", contentEn: "This heading covers parts of railway or tramway locomotives or rolling-stock such as bogies, axles, wheels, axle-boxes, brake gear, buffers, coupling gear and parts thereof." },
      { code: "86.08", titleVi: "Bộ phận cố định và ghép nối của đường ray đường sắt hoặc tàu điện; thiết bị phát tín hiệu, an toàn hoặc điều khiển giao thông bằng cơ khí", titleEn: "Railway or tramway track fixtures and fittings; mechanical signalling, safety or traffic control equipment", contentVi: "Nhóm này bao gồm các đường ray đã lắp ráp, vòng quay, bệ giảm chấn, khổ đường ray chất hàng, và các thiết bị phát tín hiệu, an toàn hoặc điều khiển giao thông bằng cơ khí cho đường sắt, đường bộ, đường thủy nội địa, cảng hoặc sân bay.", contentEn: "This heading covers assembled track, turntables, platform buffers, loading gauges, and mechanical signalling, safety or traffic control equipment for railways, roads, inland waterways, port installations or airfields." },
      { code: "86.09", titleVi: "Công-te-nơ (kể cả công-te-nơ chở chất lỏng) được thiết kế và trang bị đặc biệt để vận chuyển bằng một hoặc nhiều phương thức vận tải", titleEn: "Containers (including containers for the transport of fluids) specially designed and equipped for carriage by one or more modes of transport", contentVi: "Nhóm này bao gồm các công-te-nơ được thiết kế đặc biệt để vận chuyển bằng nhiều phương thức vận tải như đường sắt, đường bộ, đường biển hoặc đường hàng không.", contentEn: "This heading covers containers specially designed for carriage by multiple modes of transport such as railway, road, sea or air." }
    ]
  },
  {
    chapter: 87,
    ...
    sectionTitleVi: "XE CỘ, PHƯƠNG TIỆN BAY, TÀU THUYỀN VÀ CÁC THIẾT BỊ VẬN TẢI LIÊN HỢP",
    sectionTitleEn: "VEHICLES, AIRCRAFT, VESSELS AND ASSOCIATED TRANSPORT EQUIPMENT",
    titleVi: "Xe cộ trừ phương tiện chạy trên đường ray xe lửa hoặc xe điện, và các bộ phận và phụ kiện của chúng",
    titleEn: "Vehicles other than railway or tramway rolling-stock, and parts and accessories thereof",
    notesVi: [
      "1. Chương này không bao gồm các phương tiện được thiết kế chỉ để chạy trên đường ray.",
      "2. Trong Chương này, \"xe kéo\" có nghĩa là xe có bánh xe hoặc bánh xích được thiết kế chủ yếu để kéo hoặc đẩy một phương tiện, thiết bị hoặc vật nặng khác.",
      "3. Phương tiện có động cơ được thiết kế cho cả vận tải hàng hóa và vận tải hành khách được phân loại theo tiêu chí chính của chúng.",
      "4. Khung gầm đã lắp ca bin được phân loại vào nhóm 87.02 đến 87.04, và không được phân loại vào nhóm 87.06."
    ],
    notesEn: [
      "1. This Chapter does not cover railway or tramway rolling-stock designed solely for running on rails.",
      "2. In this Chapter \"tractors\" means vehicles designed essentially for hauling or pushing another vehicle, appliance or load.",
      "3. Motor vehicles designed for both transport of passengers and goods are to be classified according to their principal criterion.",
      "4. Chassis fitted with cabs are to be classified in headings 87.02 to 87.04, and not in heading 87.06."
    ],
    generalVi: "Chương này bao gồm tất cả các phương tiện giao thông trên đường bộ như xe kéo, ô tô, xe mô tô, xe đạp, rơ moóc, các bộ phận và phụ kiện của chúng, trừ các phương tiện chạy trên đường ray đường sắt hoặc tàu điện.",
    generalEn: "This Chapter covers all road vehicles such as tractors, motor cars, motorcycles, bicycles, trailers, and parts and accessories thereof, excluding railway or tramway rolling-stock.",
    headings: [
      { code: "87.01", titleVi: "Xe kéo (trừ xe kéo thuộc nhóm 87.09)", titleEn: "Tractors (other than tractors of heading 87.09)", contentVi: "Xe kéo có nghĩa là những xe chạy bằng bánh hơi hoặc bánh xích sắt được chế tạo chủ yếu để kéo hoặc đẩy một phương tiện, thiết bị hoặc vật nặng khác. Nhóm này bao gồm xe kéo các loại như máy kéo nông nghiệp, xe kéo lâm nghiệp, xe kéo đường bộ, máy kéo hạng nặng dùng trong xây dựng.", contentEn: "Tractors means wheeled or track-laying vehicles constructed essentially for hauling or pushing another vehicle, appliance or load. The heading covers tractors of various types such as agricultural tractors, forestry tractors, road tractors, heavy duty tractors for constructional engineering work." },
      { code: "87.02", titleVi: "Xe ô tô chở 10 người trở lên, kể cả lái xe", titleEn: "Motor vehicles for the transport of ten or more persons, including the driver", contentVi: "Nhóm này bao gồm các loại xe buýt, xe buýt đường dài và xe ô tô chở khách lớn được thiết kế để chở 10 người trở lên (kể cả lái xe).", contentEn: "This heading covers buses, coaches and large passenger vehicles designed to carry ten or more persons (including the driver)." },
      { code: "87.03", titleVi: "Ô tô và các loại xe khác có động cơ được thiết kế chủ yếu để chở người (trừ các loại thuộc nhóm 87.02), kể cả ô tô chở người có khoang hành lý chung và ô tô đua", titleEn: "Motor cars and other motor vehicles principally designed for the transport of persons (other than those of heading 87.02), including station wagons and racing cars", contentVi: "Nhóm này bao gồm ô tô chở người, ô tô nhiều chỗ ngồi, ô tô thể thao, xe đua và xe chở người đặc biệt như xe cấp cứu và xe tang.", contentEn: "This heading covers motor cars for the transport of persons, station wagons, sports cars, racing cars and special purpose vehicles such as ambulances and hearses." },
      { code: "87.04", titleVi: "Xe có động cơ dùng để vận tải hàng hóa", titleEn: "Motor vehicles for the transport of goods", contentVi: "Nhóm này bao gồm xe tải các loại như xe tải thông thường, xe tải tự đổ, xe tải đông lạnh, xe tải xi téc và các xe chuyên dụng khác để vận chuyển hàng hóa.", contentEn: "This heading covers trucks of all types such as ordinary lorries, tipping lorries, refrigerated lorries, tanker lorries and other specialized vehicles for transport of goods." },
      { code: "87.05", titleVi: "Xe có động cơ chuyên dùng, trừ các loại được thiết kế chủ yếu dùng để chở người hoặc hàng hóa", titleEn: "Special purpose motor vehicles, other than those principally designed for the transport of persons or goods", contentVi: "Nhóm này bao gồm xe cần cẩu, xe cứu hỏa, xe thang cứu hỏa, xe cứu thương, xe quét đường, xe phun nước, xe truyền thanh, xe chiếu phim và các xe chuyên dụng khác.", contentEn: "This heading covers mobile cranes, fire fighting vehicles, fire escape ladders, breakdown lorries, road sweepers, spraying lorries, mobile broadcasting vehicles, mobile cinema vans and other specialized vehicles." },
      { code: "87.08", titleVi: "Bộ phận và phụ kiện của xe có động cơ thuộc các nhóm từ 87.01 đến 87.05", titleEn: "Parts and accessories of the motor vehicles of headings 87.01 to 87.05", contentVi: "Nhóm này bao gồm các bộ phận và phụ kiện của xe có động cơ như cản trước và sau, hộp số, cầu xe, bánh xe, khung gầm, thân xe, ghế ngồi và các bộ phận khác.", contentEn: "This heading covers parts and accessories of motor vehicles such as bumpers, gear boxes, drive-axles, road wheels, chassis, bodies, seats and other components." },
      { code: "87.11", titleVi: "Mô tô (kể cả mopeds) và xe đạp có gắn động cơ phụ trợ, có hoặc không có thùng xe bên cạnh; thùng xe bên cạnh", titleEn: "Motorcycles (including mopeds) and cycles fitted with an auxiliary motor, with or without side-cars; side-cars", contentVi: "Nhóm này bao gồm mô tô, xe máy và xe đạp có gắn động cơ phụ trợ các loại, kể cả loại có thùng xe bên cạnh.", contentEn: "This heading covers motorcycles, motor scooters and cycles fitted with an auxiliary motor, including those with side-cars." },
      { code: "87.12", titleVi: "Xe đạp hai bánh và xe đạp khác (kể cả xe xích lô chở hàng), không lắp động cơ", titleEn: "Bicycles and other cycles (including delivery tricycles), not motorised", contentVi: "Nhóm này bao gồm xe đạp hai bánh, xe đạp đua, xe đạp thể thao, xe đạp ba bánh và các loại xe đạp khác không lắp động cơ.", contentEn: "This heading covers two-wheeled bicycles, racing bicycles, sports bicycles, tricycles and other cycles not motorised." },
      { code: "87.16", titleVi: "Rơ moóc và sơ mi rơ moóc; các loại xe khác, không có cơ cấu đẩy bằng máy; các bộ phận của chúng", titleEn: "Trailers and semi-trailers; other vehicles, not mechanically propelled; parts thereof", contentVi: "Nhóm này bao gồm rơ moóc và sơ mi rơ moóc để vận chuyển hàng hóa hoặc người, xe trại lưu động (caravans), rơ moóc xi téc và các loại xe không có cơ cấu đẩy bằng máy.", contentEn: "This heading covers trailers and semi-trailers for the transport of goods or persons, caravans, tanker trailers and other vehicles not mechanically propelled." }
    ]
  },
  {
    chapter: 88,
    ...
    sectionTitleVi: "XE CỘ, PHƯƠNG TIỆN BAY, TÀU THUYỀN VÀ CÁC THIẾT BỊ VẬN TẢI LIÊN HỢP",
    sectionTitleEn: "VEHICLES, AIRCRAFT, VESSELS AND ASSOCIATED TRANSPORT EQUIPMENT",
    titleVi: "Phương tiện bay, tàu vũ trụ và các bộ phận của chúng",
    titleEn: "Aircraft, spacecraft, and parts thereof",
    notesVi: [
      "1. Trong Chương này, phương tiện bay không người lái có nghĩa là bất kỳ phương tiện bay nào, trừ loại thuộc nhóm 88.01, được thiết kế để bay không có phi công trên máy bay.",
      "2. Theo mục đích của nhóm 88.02, thuật ngữ \"trực thăng\" và \"máy bay\" chỉ gồm những phương tiện bay có người lái.",
      "3. Nhóm 88.06 chỉ áp dụng cho phương tiện bay không người lái được thiết kế để chỉ bay không có phi công trên máy bay, có khả năng bay có điều khiển ngoài tầm nhìn tự nhiên của người điều khiển."
    ],
    notesEn: [
      "1. In this Chapter, unmanned aircraft means any aircraft, other than those of heading 88.01, designed to be flown without a pilot on board.",
      "2. For the purposes of heading 88.02, the terms \"helicopters\" and \"aeroplanes\" cover only manned aircraft.",
      "3. Heading 88.06 applies only to unmanned aircraft designed to fly only without a pilot on board, which are capable of controlled flight beyond the natural line of sight of the operator."
    ],
    generalVi: "Chương này bao gồm phương tiện bay các loại như khinh khí cầu, diều, trực thăng, máy bay, tàu vũ trụ, dù, thiết bị phóng phương tiện bay và thiết bị huấn luyện bay mặt đất.",
    generalEn: "This Chapter covers aircraft of all kinds such as balloons, gliders, helicopters, aeroplanes, spacecraft, parachutes, aircraft launching gear and ground flying trainers.",
    headings: [
      { code: "88.01", titleVi: "Khinh khí cầu và khí cầu có thể điều khiển được; tàu lượn, diều và các phương tiện bay khác không dùng động cơ", titleEn: "Balloons and dirigibles; gliders, hang gliders and other non-powered aircraft", contentVi: "Nhóm này bao gồm khinh khí cầu, khí cầu có thể điều khiển được, tàu lượn không động cơ, diều lượn và các phương tiện bay khác không có động cơ đẩy.", contentEn: "This heading covers balloons, dirigibles, gliders without engines, hang gliders and other non-powered aircraft." },
      { code: "88.02", titleVi: "Phương tiện bay khác (ví dụ, trực thăng, máy bay); trừ phương tiện bay không người lái thuộc nhóm 88.06; tàu vũ trụ và phương tiện đẩy để phóng tàu vũ trụ", titleEn: "Other aircraft (for example, helicopters, aeroplanes); except unmanned aircraft of heading 88.06; spacecraft and suborbital and spacecraft launch vehicles", contentVi: "Nhóm này bao gồm trực thăng, máy bay các loại dùng cho mục đích quân sự, vận chuyển người hoặc hàng hóa, tàu vũ trụ và các phương tiện đẩy để phóng tàu vũ trụ.", contentEn: "This heading covers helicopters, aeroplanes of all kinds for military purposes, transport of persons or goods, spacecraft and spacecraft launch vehicles." },
      { code: "88.03", titleVi: "Bộ phận của các mặt hàng thuộc nhóm 88.01 hoặc 88.02", titleEn: "Parts of goods of heading 88.01 or 88.02", contentVi: "Nhóm này bao gồm các bộ phận của khinh khí cầu, tàu lượn, trực thăng, máy bay và tàu vũ trụ như cánh quạt, cánh máy bay, thân máy bay, bộ phận hạ cánh.", contentEn: "This heading covers parts of balloons, gliders, helicopters, aeroplanes and spacecraft such as propellers, aircraft wings, fuselages, landing gear." },
      { code: "88.04", titleVi: "Dù (kể cả dù điều khiển được và dù lượn) và dù xoay; các bộ phận và phụ kiện của chúng", titleEn: "Parachutes (including dirigible parachutes and paragliders) and rotochutes; parts thereof and accessories thereto", contentVi: "Nhóm này bao gồm các loại dù dùng thả người, thiết bị quân sự, dụng cụ khí tượng, pháo sáng, cũng như dù lượn và dù xoay.", contentEn: "This heading covers parachutes used for the descent of personnel, military supplies, meteorological instruments, flares, as well as paragliders and rotochutes." },
      { code: "88.05", titleVi: "Thiết bị phóng dùng cho phương tiện bay; dàn hãm tốc độ dùng cho tàu sân bay hoặc thiết bị tương tự; thiết bị huấn luyện bay mặt đất", titleEn: "Aircraft launching gear; deck-arrestor or similar gear; ground flying trainers; parts of the foregoing articles", contentVi: "Nhóm này bao gồm thiết bị phóng phương tiện bay, dàn hãm tốc độ dùng cho tàu sân bay, thiết bị huấn luyện bay mặt đất như máy mô phỏng bay.", contentEn: "This heading covers aircraft launching gear, deck-arrestor gear for aircraft carriers, ground flying trainers such as flight simulators." },
      { code: "88.06", titleVi: "Phương tiện bay không người lái", titleEn: "Unmanned aircraft", contentVi: "Nhóm này bao gồm phương tiện bay không người lái được thiết kế để bay không có phi công trên máy bay, có khả năng bay có điều khiển ngoài tầm nhìn tự nhiên của người điều khiển.", contentEn: "This heading covers unmanned aircraft designed to fly without a pilot on board, which are capable of controlled flight beyond the natural line of sight of the operator." }
    ]
  },
  {
    chapter: 89,
    ...
    sectionTitleVi: "XE CỘ, PHƯƠNG TIỆN BAY, TÀU THUYỀN VÀ CÁC THIẾT BỊ VẬN TẢI LIÊN HỢP",
    sectionTitleEn: "VEHICLES, AIRCRAFT, VESSELS AND ASSOCIATED TRANSPORT EQUIPMENT",
    titleVi: "Tàu thủy, thuyền và các kết cấu nổi",
    titleEn: "Ships, boats and floating structures",
    notesVi: [
      ...
      "2. Cần chú ý là Chương 89 không quy định cho các bộ phận (trừ thân tàu) hoặc các phụ kiện của tàu biển, thuyền hoặc các cấu trúc nổi. Những bộ phận và phụ kiện như vậy được phân loại vào các nhóm tương ứng."
    ],
    notesEn: [
      "1. Hulls, incomplete or unfinished vessels, assembled or disassembled, or complete vessels unassembled or disassembled are to be classified in heading 89.06 if they do not have the essential character of a particular kind of vessel.",
      "2. Note that Chapter 89 makes no provision for parts (other than hulls) or accessories of ships, boats or floating structures. Such parts and accessories are classified in their respective headings."
    ],
    generalVi: "Chương này bao gồm tàu thuyền các loại tự hành hoặc không, cả các kết cấu nổi như giếng chìm, thùng nổi buộc tàu thuyền, bến tàu, phao tiêu và các xe đệm không khí được thiết kế để di chuyển trên mặt nước.",
    generalEn: "This Chapter covers ships and boats of all types whether self-propelled or not, including floating structures such as coffer-dams, pontoons, floating docks, buoys and air-cushion vehicles designed to travel over water.",
    headings: [
      { code: "89.01", titleVi: "Tàu du lịch, tàu tham quan, phà, tàu chở hàng, sà lan và các tàu thuyền tương tự để vận chuyển người hoặc hàng hóa", titleEn: "Cruise ships, excursion boats, ferry-boats, cargo ships, barges and similar vessels for the transport of persons or goods", contentVi: "Nhóm này bao gồm tàu du lịch, tàu tham quan, phà các loại, tàu chở dầu, tàu đông lạnh, tàu chở hàng, sà lan để vận chuyển hàng hóa hoặc người.", contentEn: "This heading covers cruise ships, excursion boats, ferry-boats of all kinds, tankers, refrigerated vessels, cargo vessels, barges for transport of goods or persons." },
      { code: "89.02", titleVi: "Tàu thuyền đánh bắt thủy sản; tàu chế biến và các loại tàu khác dùng cho chế biến hay bảo quản thủy sản đánh bắt", titleEn: "Fishing vessels; factory ships and other vessels for processing or preserving fishery products", contentVi: "Nhóm này bao gồm tất cả các loại tàu thuyền đánh bắt hải sản thiết kế cho nghề đánh bắt trên biển hoặc trên các mặt nước nội địa, cũng như tàu chế biến thủy sản.", contentEn: "This heading covers all types of fishing vessels designed for commercial fishing at sea or on inland waters, as well as factory ships for processing fishery products." },
      { code: "89.03", titleVi: "Du thuyền hạng nhẹ và các loại tàu thuyền khác phục vụ nghỉ ngơi, giải trí hoặc thể thao; thuyền dùng mái chèo và canô", titleEn: "Yachts and other vessels for pleasure or sports; rowing boats and canoes", contentVi: "Nhóm này bao gồm du thuyền, thuyền buồm, thuyền máy, xuồng bơm hơi, thuyền đua, thuyền đạp chân và thuyền cứu hộ dùng mái chèo.", contentEn: "This heading covers yachts, sailboats, motorboats, inflatable boats, racing boats, pedalos and rowing lifeboats." },
      { code: "89.04", titleVi: "Tàu kéo và tàu đẩy", titleEn: "Tugs and pusher craft", contentVi: "Nhóm này bao gồm tàu kéo được thiết kế chủ yếu để kéo các tàu khác và tàu đẩy được thiết kế đặc biệt để đẩy các sà lan.", contentEn: "This heading covers tugs designed mainly for towing other vessels and pusher craft specially designed for pushing barges." },
      { code: "89.05", titleVi: "Tàu đèn hiệu, tàu cứu hỏa, tàu hút nạo vét, cần cẩu nổi và tàu thuyền khác mà tính năng di động trên mặt nước chỉ nhằm bổ sung cho chức năng chính; ụ nổi sửa chữa tàu; dàn khoan hoặc dàn sản xuất nổi", titleEn: "Light-vessels, fire-floats, dredgers, floating cranes, and other vessels where navigability is subsidiary to main function; floating docks; floating or submersible drilling or production platforms", contentVi: "Nhóm này bao gồm tàu đèn hiệu, tàu cứu hỏa, tàu cuốc, cần cẩu nổi, ụ nổi sửa chữa tàu và dàn khoan hoặc dàn sản xuất nổi hoặc nửa nổi nửa chìm.", contentEn: "This heading covers light-vessels, fire-floats, dredgers, floating cranes, floating docks and floating or submersible drilling or production platforms." },
      { code: "89.06", titleVi: "Tàu thuyền khác, kể cả tàu chiến và xuồng cứu sinh trừ thuyền dùng mái chèo", titleEn: "Other vessels, including warships and lifeboats other than rowing boats", contentVi: "Nhóm này bao gồm tàu chiến các loại, tàu ngầm, tàu nghiên cứu khoa học, tàu rải cáp, tàu hoa tiêu, tàu phá băng, tàu bệnh viện và thuyền cứu sinh.", contentEn: "This heading covers warships of all kinds, submarines, research vessels, cable-laying ships, pilot vessels, ice-breakers, hospital ships and lifeboats." },
      { code: "89.07", titleVi: "Các kết cấu nổi khác (ví dụ, bè, thùng chứa, giếng chìm, cầu phao, phao đèn và phao tiêu)", titleEn: "Other floating structures (for example, rafts, tanks, coffer-dams, landing-stages, buoys and beacons)", contentVi: "Nhóm này bao gồm các kết cấu nổi như bè, thùng chứa nổi, giếng chìm để làm việc dưới nước, cầu phao, phao đèn và phao tiêu.", contentEn: "This heading covers floating structures such as rafts, floating tanks, coffer-dams for underwater work, pontoon bridges, buoys and beacons." }
    ]
  },
  {
    chapter: 90,
    section: 18,
    sectionTitleVi: "DỤNG CỤ VÀ THIẾT BỊ QUANG HỌC, NHIẾP ẢNH, ĐIỆN ẢNH, ĐO LƯỜNG, KIỂM TRA, CHÍNH XÁC, Y TẾ HOẶC PHẪU THUẬT; ĐỒNG HỒ THỜI GIAN VÀ ĐỒNG HỒ CÁ NHÂN; NHẠC CỤ; CÁC BỘ PHẬN VÀ PHỤ KIỆN CỦA CHÚNG",
    sectionTitleEn: "OPTICAL, PHOTOGRAPHIC, CINEMATOGRAPHIC, MEASURING, CHECKING, PRECISION, MEDICAL OR SURGICAL INSTRUMENTS AND APPARATUS; CLOCKS AND WATCHES; MUSICAL INSTRUMENTS; PARTS AND ACCESSORIES THEREOF",
    titleVi: "Dụng cụ và thiết bị quang học, nhiếp ảnh, điện ảnh, đo lường, kiểm tra, chính xác, y tế hoặc phẫu thuật; các bộ phận và phụ kiện của chúng",
    titleEn: "Optical, photographic, cinematographic, measuring, checking, precision, medical or surgical instruments and apparatus; parts and accessories thereof",
    notesVi: [
      "1. Chương này không bao gồm: (a) Các mặt hàng sử dụng trong máy, thiết bị hoặc cho các mục đích kỹ thuật khác, bằng cao su lưu hóa trừ cao su cứng (nhóm 40.16), bằng da thuộc hoặc da tổng hợp (nhóm 42.05) hoặc bằng vật liệu dệt (nhóm 59.11); (b) Băng, đai hoặc các sản phẩm trợ giúp khác bằng vật liệu dệt, có tính đàn hồi được dùng làm dụng cụ để nâng hoặc giữ bộ phận cơ thể (Phần XI); (c) Hàng hóa chịu lửa của nhóm 69.03; đồ gốm sứ dùng trong phòng thí nghiệm thuộc nhóm 69.09; (d) Gương thủy tinh, chưa gia công quang học, thuộc nhóm 70.09; (e) Hàng hóa thuộc nhóm 70.07, 70.08, 70.11, 70.14, 70.15 hoặc 70.17.",
      "2. Các bộ phận và phụ kiện cho các máy, thiết bị, dụng cụ hoặc các mặt hàng của Chương này được phân loại theo các nguyên tắc: (a) Các bộ phận và phụ kiện là hàng hóa thuộc nhóm bất kỳ trong Chương này hoặc Chương 84, 85 hoặc 91 được phân loại vào các nhóm riêng của chúng; (b) Các bộ phận và phụ kiện khác, nếu chỉ dùng hoặc chủ yếu dùng cho một loại máy riêng biệt được phân loại theo máy đó; (c) Tất cả các bộ phận và phụ kiện khác được phân loại trong nhóm 90.33.",
      "3. Các quy định trong Chú giải 3 và 4 của Phần XVI cũng áp dụng đối với Chương này.",
      "4. Nhóm 90.05 không áp dụng cho kính ngắm dùng để lắp vào vũ khí, kính ngắm tiềm vọng để lắp vào tàu ngầm hoặc xe tăng, hoặc kính viễn vọng dùng cho máy, thiết bị của Chương này hoặc của Phần XVI; các loại này được phân loại vào nhóm 90.13.",
      "5. Những dụng cụ, thiết bị hoặc máy quang học dùng để đo hoặc kiểm tra, có thể phân loại ở cả 2 nhóm 90.13 và 90.31 thì phải xếp vào nhóm 90.31.",
      "6. Theo mục đích của nhóm 90.21, thuật ngữ \"các dụng cụ chỉnh hình\" được hiểu là các dụng cụ dùng để ngăn ngừa hoặc điều chỉnh một số biến dạng của cơ thể; hoặc trợ giúp hoặc nẹp giữ các bộ phận cơ thể sau khi bị bệnh, phẫu thuật hoặc bị thương.",
      "7. Nhóm 90.32 chỉ áp dụng với các thiết bị và dụng cụ dùng để điều khiển tự động dòng chảy, mức, áp suất hoặc các biến số khác của chất lỏng hoặc chất khí, hoặc dùng để điều khiển tự động nhiệt độ."
    ],
    notesEn: [
      "1. This Chapter does not cover: (a) Articles of a kind used in machines, appliances or for other technical uses, of vulcanised rubber other than hard rubber (heading 40.16), of leather or of composition leather (heading 42.05) or of textile material (heading 59.11); (b) Supporting belts or other support articles of textile material (Section XI); (c) Refractory goods of heading 69.03; ceramic laboratory, chemical or other technical articles of heading 69.09; (d) Glass mirrors, not optically worked, of heading 70.09; (e) Goods of heading 70.07, 70.08, 70.11, 70.14, 70.15 or 70.17.",
      "2. Parts and accessories for machines, appliances, instruments or articles of this Chapter are to be classified according to the following rules: (a) Parts and accessories which are goods included in any of the headings of this Chapter or of Chapter 84, 85 or 91 are in all cases to be classified in their respective headings; (b) Other parts and accessories, if suitable for use solely or principally with a particular kind of machine, instrument or apparatus are to be classified with that machine; (c) All other parts and accessories are to be classified in heading 90.33.",
      ...
      "5. Measuring or checking optical instruments, appliances or machines which could be classified both in heading 90.13 and in heading 90.31 are to be classified in heading 90.31.",
      ...
      "7. Heading 90.32 applies only to instruments and apparatus for automatically controlling the flow, level, pressure or other variables of liquids or gases, or for automatically controlling temperature."
    ],
    generalVi: "Chương này bao gồm các loại dụng cụ và thiết bị được đặc trưng bởi mức độ hoàn thiện và chính xác cao. Hầu hết chúng được sử dụng chủ yếu cho mục đích khoa học (nghiên cứu trong phòng thí nghiệm, phân tích, thiên văn học), cho công nghiệp hoặc kỹ thuật chuyên ngành (đo lường hoặc kiểm tra, quan sát) hoặc cho các mục đích y học.",
    generalEn: "This Chapter covers instruments and apparatus which, as a rule, are characterised by their high degree of finish and precision. Most of them are used mainly for scientific purposes (laboratory research, analysis, astronomy), for industrial or technical purposes (measuring or checking, observation) or for medical purposes.",
    headings: [
      { code: "90.01", titleVi: "Sợi quang và bó sợi quang; cáp sợi quang trừ loại thuộc nhóm 85.44; tấm phân cực; thấu kính, lăng kính, gương và các bộ phận quang học khác", titleEn: "Optical fibres and optical fibre bundles; optical fibre cables other than those of heading 85.44; sheets and plates of polarising material; lenses, prisms, mirrors and other optical elements", contentVi: "Nhóm này bao gồm sợi quang và bó sợi quang, cáp sợi quang, tấm phân cực và các bộ phận quang học như thấu kính, lăng kính, gương.", contentEn: "This heading covers optical fibres and optical fibre bundles, optical fibre cables, sheets of polarising material and optical elements such as lenses, prisms and mirrors." },
      { code: "90.02", titleVi: "Thấu kính, lăng kính, gương và các bộ phận quang học khác, đã lắp ráp, là bộ phận hoặc phụ kiện của các dụng cụ hoặc thiết bị", titleEn: "Lenses, prisms, mirrors and other optical elements, of any material, mounted, being parts of or fittings for instruments or apparatus", contentVi: "Nhóm này bao gồm các bộ phận quang học đã lắp ráp, là bộ phận hoặc phụ kiện của các dụng cụ hoặc thiết bị.", contentEn: "This heading covers mounted optical elements being parts of or fittings for instruments or apparatus." },
      { code: "90.03", titleVi: "Gọng và khung kính, và bộ phận của chúng", titleEn: "Frames and mountings for spectacles, goggles or the like, and parts thereof", contentVi: "Nhóm này bao gồm gọng và khung kính dùng cho kính đeo mắt, kính bảo hộ hoặc các loại tương tự.", contentEn: "This heading covers frames and mountings for spectacles, goggles or the like." },
      { code: "90.04", titleVi: "Kính đeo mắt, kính bảo hộ và các loại tương tự, dùng để điều chỉnh, bảo vệ hoặc các mục đích khác", titleEn: "Spectacles, goggles and the like, corrective, protective or other", contentVi: "Nhóm này bao gồm kính đeo mắt thông thường, kính râm, kính bảo hộ cho công nhân, kính bảo vệ mắt khi hàn, kính đeo khi trượt tuyết và kính bơi.", contentEn: "This heading covers ordinary spectacles, sunglasses, protective goggles for workers, welding goggles, skiing goggles and swimming goggles." },
      { code: "90.05", titleVi: "Ống nhòm loại hai mắt, ống nhòm đơn, kính viễn vọng quang học khác, và khung giá của các loại trên; các dụng cụ thiên văn khác", titleEn: "Binoculars, monoculars, other optical telescopes, and mountings therefor; other astronomical instruments", contentVi: "Nhóm này bao gồm ống nhòm, kính viễn vọng, kính thiên văn và các dụng cụ thiên văn khác.", contentEn: "This heading covers binoculars, telescopes, astronomical telescopes and other astronomical instruments." },
      { code: "90.06", titleVi: "Máy ảnh (trừ máy quay phim); thiết bị đèn chớp và đèn flash máy ảnh", titleEn: "Photographic cameras other than cinematographic; photographic flashlight apparatus and flashbulbs", contentVi: "Nhóm này bao gồm các loại máy ảnh (trừ máy quay phim) sử dụng theo các mục đích chuyên nghiệp hoặc nghiệp dư, và thiết bị đèn flash.", contentEn: "This heading covers photographic cameras other than cinematographic, for professional or amateur use, and flashlight apparatus." },
      { code: "90.07", titleVi: "Máy quay phim và máy chiếu phim, có hoặc không có bộ phận ghi hoặc phát lại âm thanh", titleEn: "Cinematographic cameras and projectors, whether or not incorporating sound recording or reproducing apparatus", contentVi: "Nhóm này bao gồm máy quay phim và máy chiếu phim các loại.", contentEn: "This heading covers cinematographic cameras and projectors of all kinds." },
      { code: "90.08", titleVi: "Máy chiếu hình ảnh, trừ máy chiếu phim; máy phóng ảnh và máy thu ảnh", titleEn: "Image projectors, other than cinematographic; photographic enlargers and reducers", contentVi: "Nhóm này bao gồm máy chiếu hình ảnh, máy phóng ảnh và máy thu ảnh dùng trong nhiếp ảnh.", contentEn: "This heading covers image projectors, photographic enlargers and reducers." },
      { code: "90.10", titleVi: "Thiết bị và dụng cụ dùng trong phòng thí nghiệm ảnh; máy dùng để chiếu mạch điện lên vật liệu bán dẫn có độ nhạy; màn hình để chiếu ảnh", titleEn: "Apparatus and equipment for photographic laboratories; negatoscopes; projection screens", contentVi: "Nhóm này bao gồm thiết bị phòng thí nghiệm ảnh, màn chiếu phim và thiết bị chiếu mạch điện lên vật liệu bán dẫn.", contentEn: "This heading covers photographic laboratory equipment, projection screens and apparatus for projecting circuit patterns onto sensitized semiconductor materials." },
      { code: "90.11", titleVi: "Kính hiển vi quang học phức hợp, kể cả loại dùng cho chụp hiển vi, chiếu hiển vi điện ảnh hoặc chiếu hiển vi", titleEn: "Compound optical microscopes, including those for photomicrography, cinephotomicrography or microprojection", contentVi: "Nhóm này bao gồm kính hiển vi quang học phức hợp dùng trong nghiên cứu khoa học, y học và công nghiệp.", contentEn: "This heading covers compound optical microscopes used in scientific research, medicine and industry." },
      { code: "90.12", titleVi: "Kính hiển vi trừ loại kính hiển vi quang học; máy nhiễu xạ", titleEn: "Microscopes other than optical microscopes; diffraction apparatus", contentVi: "Nhóm này bao gồm kính hiển vi điện tử, kính hiển vi proton và máy nhiễu xạ.", contentEn: "This heading covers electron microscopes, proton microscopes and diffraction apparatus." },
      { code: "90.13", titleVi: "Thiết bị tinh thể lỏng chưa được chi tiết ở nơi khác; laser, trừ diot laser; các dụng cụ và thiết bị quang học khác", titleEn: "Liquid crystal devices not constituting articles provided for more specifically elsewhere; lasers, other than laser diodes; other optical appliances and instruments", contentVi: "Nhóm này bao gồm thiết bị tinh thể lỏng, laser và các dụng cụ quang học khác như kính ngắm, kính tiềm vọng.", contentEn: "This heading covers liquid crystal devices, lasers and other optical appliances such as telescopic sights and periscopes." },
      { code: "90.14", titleVi: "La bàn định hướng; dụng cụ và thiết bị hàng hải khác", titleEn: "Direction finding compasses; other navigational instruments and appliances", contentVi: "Nhóm này bao gồm la bàn, máy đo độ sâu, máy đo tốc độ tàu và các thiết bị dẫn đường hàng hải khác.", contentEn: "This heading covers compasses, sounding apparatus, log books and other navigational instruments." },
      { code: "90.15", titleVi: "Dụng cụ và thiết bị trắc địa, trắc địa phẳng, địa hình, đo đạc, thủy văn, đại dương học, thủy học, khí tượng học hoặc địa vật lý", titleEn: "Surveying, hydrographic, oceanographic, hydrological, meteorological or geophysical instruments and appliances", contentVi: "Nhóm này bao gồm máy kinh vĩ, máy đo mức, máy đo khoảng cách và các thiết bị đo đạc trắc địa khác.", contentEn: "This heading covers theodolites, levels, range-finders and other surveying instruments." },
      { code: "90.17", titleVi: "Dụng cụ vẽ, vạch hoặc tính toán; dụng cụ cầm tay để đo chiều dài", titleEn: "Drawing, marking-out or mathematical calculating instruments; instruments for measuring length, for use in the hand", contentVi: "Nhóm này bao gồm thước vẽ, compa, bút vẽ, thước đo và các dụng cụ tính toán toán học.", contentEn: "This heading covers drawing rulers, compasses, drawing pens, measuring instruments and mathematical calculating instruments." },
      { code: "90.18", titleVi: "Dụng cụ và thiết bị dùng trong y học, phẫu thuật, nha khoa hoặc thú y", titleEn: "Instruments and appliances used in medical, surgical, dental or veterinary sciences", contentVi: "Nhóm này bao gồm các dụng cụ y tế, phẫu thuật, nha khoa và thú y như ống nghe, máy đo huyết áp, dao mổ, kẹp phẫu thuật.", contentEn: "This heading covers medical, surgical, dental and veterinary instruments such as stethoscopes, blood pressure monitors, scalpels and surgical forceps." },
      { code: "90.19", titleVi: "Thiết bị trị liệu cơ học; máy massage; máy thử nghiệm năng lực tâm sinh lý; máy liệu pháp ozon, oxy, khí dung, hô hấp nhân tạo", titleEn: "Mechano-therapy appliances; massage apparatus; psychological aptitude-testing apparatus; ozone therapy, oxygen therapy, aerosol therapy, artificial respiration apparatus", contentVi: "Nhóm này bao gồm các thiết bị vật lý trị liệu, máy massage và thiết bị hô hấp nhân tạo.", contentEn: "This heading covers physiotherapy apparatus, massage machines and artificial respiration equipment." },
      { code: "90.20", titleVi: "Thiết bị thở và mặt nạ phòng khí độc khác, trừ mặt nạ bảo hộ không có bộ phận cơ học và không có bộ phận lọc có thể thay thế được", titleEn: "Other breathing appliances and gas masks, excluding protective masks having neither mechanical parts nor replaceable filters", contentVi: "Nhóm này bao gồm mặt nạ phòng độc và thiết bị thở dưới nước.", contentEn: "This heading covers gas masks and underwater breathing apparatus." },
      { code: "90.21", titleVi: "Dụng cụ chỉnh hình, kể cả nạng, đai phẫu thuật và đai thoát vị; nẹp và các dụng cụ dùng cho gãy xương khác; các bộ phận cơ thể nhân tạo", titleEn: "Orthopaedic appliances, including crutches, surgical belts and trusses; splints and other fracture appliances; artificial parts of the body", contentVi: "Nhóm này bao gồm dụng cụ chỉnh hình, nạng, đai phẫu thuật, nẹp xương và các bộ phận cơ thể nhân tạo.", contentEn: "This heading covers orthopaedic appliances, crutches, surgical belts, bone splints and artificial body parts." },
      { code: "90.22", titleVi: "Thiết bị sử dụng tia X hoặc các bức xạ alpha, beta, gamma hoặc các loại bức xạ ion hóa khác", titleEn: "Apparatus based on the use of X-rays or of alpha, beta, gamma or other ionising radiations", contentVi: "Nhóm này bao gồm máy X-quang dùng cho mục đích y tế, nha khoa, công nghiệp và an ninh.", contentEn: "This heading covers X-ray apparatus for medical, dental, industrial and security purposes." },
      { code: "90.24", titleVi: "Máy và dụng cụ dùng để thử độ cứng, độ bền, độ nén, độ đàn hồi hoặc các tính chất cơ học khác của vật liệu", titleEn: "Machines and appliances for testing the hardness, strength, compressibility, elasticity or other mechanical properties of materials", contentVi: "Nhóm này bao gồm máy thử độ cứng, máy thử kéo và các thiết bị kiểm tra tính chất cơ học của vật liệu.", contentEn: "This heading covers hardness testers, tensile testing machines and other apparatus for testing mechanical properties of materials." },
      { code: "90.25", titleVi: "Tỷ trọng kế và dụng cụ nổi tương tự; nhiệt kế, hỏa kế, khí áp kế, ẩm kế và máy ghi ẩm", titleEn: "Hydrometers and similar floating instruments, thermometers, pyrometers, barometers, hygrometers and psychrometers", contentVi: "Nhóm này bao gồm tỷ trọng kế, nhiệt kế, khí áp kế, ẩm kế và các dụng cụ đo tương tự.", contentEn: "This heading covers hydrometers, thermometers, barometers, hygrometers and similar measuring instruments." },
      { code: "90.26", titleVi: "Dụng cụ và thiết bị đo hoặc kiểm tra lưu lượng, mức, áp suất hoặc các biến số khác của chất lỏng hay chất khí", titleEn: "Instruments and apparatus for measuring or checking the flow, level, pressure or other variables of liquids or gases", contentVi: "Nhóm này bao gồm lưu lượng kế, đồng hồ đo mức, áp kế và các thiết bị đo lường tương tự.", contentEn: "This heading covers flowmeters, level gauges, pressure gauges and similar measuring instruments." },
      { code: "90.27", titleVi: "Dụng cụ và thiết bị để phân tích lý hoặc hóa; dụng cụ và thiết bị đo hoặc kiểm tra độ nhớt, độ xốp, độ giãn nở, sức căng bề mặt hoặc các loại tương tự", titleEn: "Instruments and apparatus for physical or chemical analysis; instruments and apparatus for measuring or checking viscosity, porosity, expansion, surface tension or the like", contentVi: "Nhóm này bao gồm máy quang phổ, máy sắc ký và các thiết bị phân tích lý hóa khác.", contentEn: "This heading covers spectrometers, chromatographs and other physical or chemical analysis apparatus." },
      { code: "90.28", titleVi: "Đồng hồ đo lượng cung cấp hoặc sản xuất khí, chất lỏng hoặc điện", titleEn: "Gas, liquid or electricity supply or production meters", contentVi: "Nhóm này bao gồm đồng hồ đo khí, đồng hồ đo nước và đồng hồ đo điện.", contentEn: "This heading covers gas meters, water meters and electricity meters." },
      { code: "90.29", titleVi: "Máy đếm vòng quay, máy đếm sản phẩm, đồng hồ tốc độ (taximeter), đồng hồ tính tiền gắn trên tắc xi", titleEn: "Revolution counters, production counters, taximeters, milometers, pedometers and the like", contentVi: "Nhóm này bao gồm máy đếm vòng quay, máy đếm sản phẩm, đồng hồ tốc độ và đồng hồ tính tiền taxi.", contentEn: "This heading covers revolution counters, production counters, speed indicators and taximeters." },
      { code: "90.30", titleVi: "Máy hiện sóng, máy phân tích phổ và các dụng cụ khác dùng để đo hoặc kiểm tra các đại lượng điện", titleEn: "Oscilloscopes, spectrum analysers and other instruments and apparatus for measuring or checking electrical quantities", contentVi: "Nhóm này bao gồm máy hiện sóng, máy phân tích phổ, vôn kế, ampe kế và các thiết bị đo điện khác.", contentEn: "This heading covers oscilloscopes, spectrum analysers, voltmeters, ammeters and other electrical measuring instruments." },
      { code: "90.31", titleVi: "Máy, dụng cụ và thiết bị đo lường hoặc kiểm tra, chưa được chi tiết hay ghi ở nơi khác trong Chương này; máy chiếu prôfin", titleEn: "Measuring or checking instruments, appliances and machines, not specified or included elsewhere in this Chapter; profile projectors", contentVi: "Nhóm này bao gồm các thiết bị đo lường và kiểm tra không thuộc các nhóm khác trong Chương này.", contentEn: "This heading covers measuring and checking instruments not covered elsewhere in this Chapter." },
      { code: "90.32", titleVi: "Dụng cụ và thiết bị điều chỉnh hoặc điều khiển tự động", titleEn: "Automatic regulating or controlling instruments and apparatus", contentVi: "Nhóm này bao gồm các thiết bị điều chỉnh và điều khiển tự động dùng trong công nghiệp.", contentEn: "This heading covers automatic regulating and controlling instruments used in industry." },
      { code: "90.33", titleVi: "Bộ phận và phụ kiện (chưa được chi tiết hay ghi ở nơi khác trong Chương này) dùng cho máy, dụng cụ hoặc thiết bị của Chương 90", titleEn: "Parts and accessories (not specified or included elsewhere in this Chapter) for machines, appliances, instruments or apparatus of Chapter 90", contentVi: "Nhóm này bao gồm các bộ phận và phụ kiện không được chi tiết ở nơi khác trong Chương này.", contentEn: "This heading covers parts and accessories not specified elsewhere in this Chapter." }
    ]
  },
  {
    chapter: 91,
    ...
    sectionTitleVi: "DỤNG CỤ VÀ THIẾT BỊ QUANG HỌC, NHIẾP ẢNH, ĐIỆN ẢNH, ĐO LƯỜNG, KIỂM TRA, CHÍNH XÁC, Y TẾ HOẶC PHẪU THUẬT; ĐỒNG HỒ THỜI GIAN VÀ ĐỒNG HỒ CÁ NHÂN; NHẠC CỤ; CÁC BỘ PHẬN VÀ PHỤ KIỆN CỦA CHÚNG",
    sectionTitleEn: "OPTICAL, PHOTOGRAPHIC, CINEMATOGRAPHIC, MEASURING, CHECKING, PRECISION, MEDICAL OR SURGICAL INSTRUMENTS AND APPARATUS; CLOCKS AND WATCHES; MUSICAL INSTRUMENTS; PARTS AND ACCESSORIES THEREOF",
    titleVi: "Đồng hồ thời gian, đồng hồ cá nhân và các bộ phận của chúng",
    titleEn: "Clocks and watches and parts thereof",
    notesVi: [
      "1. Chương này không bao gồm: (a) Mặt kính đồng hồ thời gian hoặc đồng hồ cá nhân hoặc quả lắc đồng hồ (được phân loại theo vật liệu cấu thành); (b) Dây đeo đồng hồ cá nhân (tùy theo từng trường hợp, thuộc nhóm 71.13 hoặc 71.17); (c) Các bộ phận có công dụng chung đã định nghĩa trong Chú giải 2 Phần XV, bằng kim loại cơ bản (Phần XV), hoặc các hàng hóa tương tự bằng plastic (Chương 39); tuy nhiên, lò xo đồng hồ được phân loại như các bộ phận của các loại đồng hồ đó (nhóm 91.14); (d) Bi của ổ bi (nhóm 73.26 hoặc 84.82); (e) Các mặt hàng thuộc nhóm 84.12 được cấu tạo để làm việc mà không có bộ phận điều tốc; (f) Ổ bi (nhóm 84.82); (g) Các mặt hàng thuộc Chương 85, chưa lắp ráp thành máy đồng hồ.",
      "2. Nhóm 91.01 chỉ bao gồm loại đồng hồ cá nhân có vỏ làm hoàn toàn bằng kim loại quý hoặc kim loại dát phủ kim loại quý, hoặc bằng cùng loại vật liệu kết hợp với ngọc trai thiên nhiên hoặc ngọc trai nuôi cấy, hoặc với đá quý hoặc đá bán quý.",
      "3. Trong Chương này, khái niệm \"máy đồng hồ cá nhân\" được hiểu là các bộ phận được điều chỉnh bằng con lắc và dây tóc, tinh thể thạch anh hoặc bất kỳ một hệ thống nào khác có thể xác định các khoảng thời gian.",
      "4. Ngoài các quy định đã nêu trong Chú giải 1, máy đồng hồ và các bộ phận khác sử dụng cho cả đồng hồ thời gian hoặc đồng hồ cá nhân và dùng cho các mặt hàng khác được phân loại trong Chương này."
    ],
    notesEn: [
      "1. This Chapter does not cover: (a) Clock or watch glasses or weights (classified according to their constituent material); (b) Watch chains (heading 71.13 or 71.17, as the case may be); (c) Parts of general use defined in Note 2 to Section XV, of base metal (Section XV), or similar goods of plastics (Chapter 39); clock or watch springs are, however, to be classified as clock or watch parts (heading 91.14); (d) Bearing balls (heading 73.26 or 84.82); (e) Articles of heading 84.12 constructed to work without an escapement; (f) Ball bearings (heading 84.82); (g) Articles of Chapter 85, not yet assembled into watch or clock movements.",
      "2. Heading 91.01 covers only watches with case wholly of precious metal or of metal clad with precious metal, or of the same materials combined with natural or cultured pearls, or precious or semi-precious stones.",
      "3. For the purposes of this Chapter, the expression \"watch movements\" means devices regulated by a balance-wheel and hairspring, quartz crystal or any other system capable of determining intervals of time.",
      "4. Except as provided in Note 1, movements and other parts suitable for use both in clocks or watches and in other articles are to be classified in this Chapter."
    ],
    generalVi: "Chương này bao gồm những thiết bị được thiết kế chủ yếu để đo thời gian hoặc để tác động vào một số hoạt động liên quan đến thời gian. Chúng bao gồm các loại đồng hồ đeo tay và đồng hồ bấm thời gian, các loại đồng hồ thời gian thông thường, đồng hồ báo thức, đồng hồ hàng hải, và các thiết bị ghi nhận thời gian.",
    generalEn: "This Chapter covers apparatus designed mainly for measuring time or for effecting some operation in relation to time. It includes watches and stop-watches, ordinary clocks, alarm clocks, marine chronometers, and time recording apparatus.",
    headings: [
      { code: "91.01", titleVi: "Đồng hồ đeo tay, đồng hồ bỏ túi và các loại đồng hồ cá nhân khác, kể cả đồng hồ bấm giờ, có vỏ bằng kim loại quý", titleEn: "Wrist-watches, pocket-watches and other watches, including stop-watches, with case of precious metal", contentVi: "Nhóm này chỉ bao gồm loại đồng hồ cá nhân có vỏ làm hoàn toàn bằng kim loại quý hoặc kim loại dát phủ kim loại quý.", contentEn: "This heading covers only watches with case wholly of precious metal or of metal clad with precious metal." },
      { code: "91.02", titleVi: "Đồng hồ đeo tay, đồng hồ bỏ túi và các loại đồng hồ cá nhân khác, kể cả đồng hồ bấm giờ, trừ loại thuộc nhóm 91.01", titleEn: "Wrist-watches, pocket-watches and other watches, including stop-watches, other than those of heading 91.01", contentVi: "Nhóm này bao gồm đồng hồ đeo tay và đồng hồ bỏ túi có vỏ không phải bằng kim loại quý.", contentEn: "This heading covers wrist-watches and pocket-watches with cases not of precious metal." },
      { code: "91.03", titleVi: "Đồng hồ thời gian có máy đồng hồ cá nhân, trừ các loại đồng hồ thuộc nhóm 91.04", titleEn: "Clocks with watch movements, excluding clocks of heading 91.04", contentVi: "Nhóm này bao gồm đồng hồ thời gian có máy đồng hồ cá nhân như đồng hồ treo tường, đồng hồ để bàn.", contentEn: "This heading covers clocks with watch movements such as wall clocks and table clocks." },
      { code: "91.04", titleVi: "Đồng hồ thời gian lắp trên bảng điều khiển phương tiện và các loại đồng hồ thời gian tương tự dùng trên xe cộ, máy bay, tàu vũ trụ hoặc tàu thủy", titleEn: "Instrument panel clocks and clocks of a similar type for vehicles, aircraft, spacecraft or vessels", contentVi: "Nhóm này bao gồm đồng hồ thời gian lắp trên bảng điều khiển xe cộ, máy bay, tàu vũ trụ hoặc tàu thủy.", contentEn: "This heading covers instrument panel clocks for vehicles, aircraft, spacecraft or vessels." },
      { code: "91.05", titleVi: "Các loại đồng hồ thời gian khác", titleEn: "Other clocks", contentVi: "Nhóm này bao gồm đồng hồ báo thức, đồng hồ treo tường, đồng hồ hàng hải và đồng hồ chính điều khiển các đồng hồ phụ.", contentEn: "This heading covers alarm clocks, wall clocks, marine chronometers and master clocks controlling secondary clocks." },
      { code: "91.06", titleVi: "Thiết bị ghi thời gian và các thiết bị dùng để đo, ghi hoặc biểu thị các khoảng thời gian bằng cách khác", titleEn: "Time of day recording apparatus and apparatus for measuring, recording or otherwise indicating intervals of time", contentVi: "Nhóm này bao gồm thiết bị chấm công, thiết bị ghi thời gian, đồng hồ chỉ báo của nhân viên bảo vệ và đồng hồ bấm giờ.", contentEn: "This heading covers time-registers, time-recorders, watchmen's tell-tales and stop-clocks." },
      { code: "91.07", titleVi: "Công tắc đóng ngắt định giờ có máy đồng hồ hoặc có động cơ đồng bộ", titleEn: "Time switches with clock or watch movement or with synchronous motor", contentVi: "Nhóm này bao gồm công tắc đóng ngắt định giờ để bật tắt thiết bị điện theo thời gian định trước.", contentEn: "This heading covers time switches for switching electrical apparatus on or off at predetermined times." },
      { code: "91.08", titleVi: "Máy đồng hồ cá nhân, hoàn chỉnh và đã lắp ráp", titleEn: "Watch movements, complete and assembled", contentVi: "Nhóm này bao gồm máy đồng hồ cá nhân hoàn chỉnh và đã lắp ráp.", contentEn: "This heading covers complete and assembled watch movements." },
      { code: "91.09", titleVi: "Máy đồng hồ thời gian, hoàn chỉnh và đã lắp ráp", titleEn: "Clock movements, complete and assembled", contentVi: "Nhóm này bao gồm máy đồng hồ thời gian hoàn chỉnh và đã lắp ráp.", contentEn: "This heading covers complete and assembled clock movements." },
      { code: "91.10", titleVi: "Máy đồng hồ thời gian hoặc đồng hồ cá nhân, hoàn chỉnh, chưa lắp ráp hoặc đã lắp ráp một phần; máy đồng hồ chưa hoàn chỉnh, đã lắp ráp", titleEn: "Complete watch or clock movements, unassembled or partly assembled; incomplete watch or clock movements, assembled", contentVi: "Nhóm này bao gồm máy đồng hồ hoàn chỉnh nhưng chưa lắp ráp và máy đồng hồ chưa hoàn chỉnh đã lắp ráp.", contentEn: "This heading covers complete movements unassembled and incomplete movements assembled." },
      { code: "91.11", titleVi: "Vỏ đồng hồ cá nhân và các bộ phận của chúng", titleEn: "Watch cases and parts thereof", contentVi: "Nhóm này bao gồm vỏ đồng hồ cá nhân bằng kim loại quý, kim loại cơ bản hoặc plastic và các bộ phận của chúng.", contentEn: "This heading covers watch cases of precious metal, base metal or plastics and parts thereof." },
      { code: "91.12", titleVi: "Vỏ đồng hồ thời gian và vỏ loại tương tự dùng cho các hàng hóa khác của Chương này, và các bộ phận của chúng", titleEn: "Clock cases and cases of a similar type for other goods of this Chapter, and parts thereof", contentVi: "Nhóm này bao gồm vỏ đồng hồ thời gian và các bộ phận của chúng.", contentEn: "This heading covers clock cases and parts thereof." },
      { code: "91.13", titleVi: "Dây đeo đồng hồ cá nhân, dây đồng hồ và vòng đeo tay dùng cho đồng hồ cá nhân, và các bộ phận của chúng", titleEn: "Watch straps, watch bands and watch bracelets, and parts thereof", contentVi: "Nhóm này bao gồm dây đeo đồng hồ cá nhân bằng kim loại, da, plastic hoặc vật liệu dệt.", contentEn: "This heading covers watch straps of metal, leather, plastics or textile material." },
      { code: "91.14", titleVi: "Các bộ phận đồng hồ thời gian hoặc đồng hồ cá nhân khác", titleEn: "Other clock or watch parts", contentVi: "Nhóm này bao gồm các bộ phận đồng hồ như mâm, cầu nối, bánh xe, kim, mặt số và lò xo.", contentEn: "This heading covers clock or watch parts such as plates, bridges, wheels, hands, dials and springs." }
    ]
  },
  {
    chapter: 92,
    ...
    sectionTitleVi: "DỤNG CỤ VÀ THIẾT BỊ QUANG HỌC, NHIẾP ẢNH, ĐIỆN ẢNH, ĐO LƯỜNG, KIỂM TRA, CHÍNH XÁC, Y TẾ HOẶC PHẪU THUẬT; ĐỒNG HỒ THỜI GIAN VÀ ĐỒNG HỒ CÁ NHÂN; NHẠC CỤ; CÁC BỘ PHẬN VÀ PHỤ KIỆN CỦA CHÚNG",
    sectionTitleEn: "OPTICAL, PHOTOGRAPHIC, CINEMATOGRAPHIC, MEASURING, CHECKING, PRECISION, MEDICAL OR SURGICAL INSTRUMENTS AND APPARATUS; CLOCKS AND WATCHES; MUSICAL INSTRUMENTS; PARTS AND ACCESSORIES THEREOF",
    titleVi: "Nhạc cụ; các bộ phận và phụ kiện của chúng",
    titleEn: "Musical instruments; parts and accessories of such articles",
    notesVi: [
      "1. Chương này không bao gồm: (a) Các bộ phận có công dụng chung, như đã định nghĩa trong Chú giải 2 Phần XV, bằng kim loại cơ bản (Phần XV), hoặc các mặt hàng tương tự bằng plastic (Chương 39); (b) Micro, amply, loa phóng thanh, tai nghe, công tắc, dụng cụ quan sát hoạt động máy hoặc thiết bị phụ trợ khác của Chương 85 hoặc 90, sử dụng phối hợp nhưng không lắp hoặc ghép vào cùng một vỏ như các thiết bị của Chương này; (c) Dụng cụ hoặc nhạc cụ đồ chơi (nhóm 95.03); (d) Chổi để làm sạch nhạc cụ (nhóm 96.03); hoặc chân đế loại một chân (monopod), hai chân (bipod), ba chân (tripod) và các mặt hàng tương tự (nhóm 96.20); (e) Bộ sưu tập hoặc đồ cổ (nhóm 97.05 hoặc 97.06).",
      "2. Cần kéo và que và các dụng cụ tương tự để chơi nhạc cụ thuộc nhóm 92.02 hoặc 92.06 đi kèm những loại nhạc cụ đó với số lượng kèm theo thông thường và được xác định rõ là sử dụng cùng với nhạc cụ, được phân loại cùng nhóm với nhạc cụ liên quan. Thẻ, đĩa và trục quay thuộc nhóm 92.09 đi kèm với nhạc cụ được xem là một mặt hàng riêng biệt."
    ],
    notesEn: [
      "1. This Chapter does not cover: (a) Parts of general use, as defined in Note 2 to Section XV, of base metal (Section XV), or similar goods of plastics (Chapter 39); (b) Microphones, amplifiers, loud-speakers, head-phones, switches, stroboscopes or other accessory instruments of Chapter 85 or 90, for use with but not incorporated in or housed in the same cabinet as instruments of this Chapter; (c) Toy instruments or apparatus (heading 95.03); (d) Brushes for cleaning musical instruments (heading 96.03), or monopods, bipods, tripods and similar articles (heading 96.20); (e) Collectors' pieces or antiques (heading 97.05 or 97.06).",
      "2. Bows and sticks and similar devices used in playing the musical instruments of heading 92.02 or 92.06 presented with such instruments in numbers normal thereto and clearly intended for use therewith, are to be classified in the same heading as the relative instruments. Cards, discs and rolls of heading 92.09 presented with an instrument are to be treated as separate articles."
    ],
    generalVi: "Chương này bao gồm những nhạc cụ (từ nhóm 92.01 đến 92.08) và các bộ phận và phụ kiện của chúng (nhóm 92.09). Một số nhạc cụ (đàn piano, guitar...) có thể có các thiết bị điện để đọc và khuếch đại âm thanh, vẫn được phân loại vào các nhóm tương ứng của Chương này nếu không có các thiết bị điện nói trên chúng vẫn sử dụng được như những nhạc cụ thông thường.",
    generalEn: "This Chapter covers musical instruments (headings 92.01 to 92.08) and parts and accessories of these instruments (heading 92.09). Some musical instruments (pianos, guitars, etc.) may have an electrical sound pick-up and amplifying device; they nevertheless remain classified in their respective headings provided that, without the electrical equipment, they can still be used like conventional instruments.",
    headings: [
      { code: "92.01", titleVi: "Đàn piano, kể cả piano tự động; đàn clavecin (harpsichords) và các loại đàn dây có phím bấm khác", titleEn: "Pianos, including automatic pianos; harpsichords and other keyboard stringed instruments", contentVi: "Nhóm này bao gồm đàn piano đứng, đại dương cầm và đàn piano tự động, cũng như đàn clavecin và các loại đàn dây có phím bấm khác.", contentEn: "This heading covers upright pianos, grand pianos and automatic pianos, as well as harpsichords and other keyboard stringed instruments." },
      { code: "92.02", titleVi: "Các nhạc cụ có dây khác (ví dụ, ghi ta, vi-ô-lông, đàn hạc)", titleEn: "Other string musical instruments (for example, guitars, violins, harps)", contentVi: "Nhóm này bao gồm nhạc cụ sử dụng cần kéo (vi-ô-lông, vi-ô-lôngxen) và các nhạc cụ có dây khác (ghi ta, mandolin, đàn hạc, banjo).", contentEn: "This heading covers instruments played with a bow (violins, violoncellos) and other string instruments (guitars, mandolins, harps, banjos)." },
      { code: "92.05", titleVi: "Nhạc cụ hơi (ví dụ, các loại đàn organ ống có phím, đàn accordion, clarinet, trumpet, kèn túi), trừ các loại đàn organ phiên chợ", titleEn: "Wind musical instruments (for example, keyboard pipe organs, accordions, clarinets, trumpets, bagpipes), other than fairground organs", contentVi: "Nhóm này bao gồm các loại kèn đồng (kèn trumpet, kèn trombon) và các loại nhạc cụ hơi khác (clarinet, sáo, đàn organ, đàn accordion).", contentEn: "This heading covers brass instruments (trumpets, trombones) and other wind instruments (clarinets, flutes, organs, accordions)." },
      { code: "92.06", titleVi: "Nhạc cụ gõ (ví dụ, trống, mộc cầm, chũm chọe, caxtanhét, maracas)", titleEn: "Percussion musical instruments (for example, drums, xylophones, cymbals, castanets, maracas)", contentVi: "Nhóm này bao gồm các nhạc cụ bộ gõ như trống, mộc cầm, tam giác, chũm chọe, castanets và maracas.", contentEn: "This heading covers percussion instruments such as drums, xylophones, triangles, cymbals, castanets and maracas." },
      { code: "92.07", titleVi: "Nhạc cụ mà âm thanh được tạo ra hoặc phải được khuếch đại bằng điện (ví dụ, đàn organ, ghi ta, đàn accordion)", titleEn: "Musical instruments, the sound of which is produced, or must be amplified, electrically (for example, organs, guitars, accordions)", contentVi: "Nhóm này bao gồm các nhạc cụ điện và điện tử như đàn organ điện tử, guitar điện, piano điện tử và bộ chuông hòa âm điện tử.", contentEn: "This heading covers electrical and electronic musical instruments such as electronic organs, electric guitars, electronic pianos and electronic carillons." },
      { code: "92.08", titleVi: "Hộp nhạc, đàn organ phiên chợ, đàn quay gió của người hát rong trên đường phố, nhạc cụ cơ khí tạo tiếng chim hót, cưa nhạc, dụng cụ gọi để nhử mồi và còi thổi bằng miệng", titleEn: "Musical boxes, fairground organs, mechanical street organs, mechanical singing birds, musical saws, cymbals and call horns and other mouth-blown sound signalling instruments", contentVi: "Nhóm này bao gồm hộp nhạc, đàn organ phiên chợ, đàn quay gió, nhạc cụ cơ khí tạo tiếng chim hót và dụng cụ phát tín hiệu âm thanh thổi bằng miệng.", contentEn: "This heading covers musical boxes, fairground organs, mechanical street organs, mechanical singing birds and mouth-blown sound signalling instruments." },
      { code: "92.09", titleVi: "Các bộ phận (ví dụ, bộ phận cơ cho hộp nhạc) và các phụ kiện (ví dụ, thẻ, đĩa và trục quay dùng cho nhạc cụ cơ học) của nhạc cụ; máy nhịp, thanh mẫu, ống tiêu và sáo các loại", titleEn: "Parts and accessories of musical instruments; metronomes, tuning forks and pitch pipes of all kinds", contentVi: "Nhóm này bao gồm máy nhịp, thanh mẫu, ống tiêu, dây nhạc cụ, bộ phận đàn piano, ghi ta, organ và các nhạc cụ khác.", contentEn: "This heading covers metronomes, tuning forks, pitch pipes, musical instrument strings, parts for pianos, guitars, organs and other instruments." }
    ]
  },
  {
    chapter: 93,
    section: 19,
    sectionTitleVi: "VŨ KHÍ VÀ ĐẠN; CÁC BỘ PHẬN VÀ PHỤ KIỆN CỦA CHÚNG",
    sectionTitleEn: "ARMS AND AMMUNITION; PARTS AND ACCESSORIES THEREOF",
    titleVi: "Vũ khí và đạn; các bộ phận và phụ kiện của chúng",
    titleEn: "Arms and ammunition; parts and accessories thereof",
    notesVi: [
      "1. Chương này không bao gồm: (a) Hàng hóa thuộc Chương 36 (ví dụ, ngòi nổ, kíp nổ, pháo hiệu); (b) Những bộ phận có công dụng chung, như đã định nghĩa trong Chú giải 2 của Phần XV, bằng kim loại cơ bản (Phần XV), hoặc hàng hóa tương tự bằng plastic (Chương 39); (c) Xe chiến đấu bọc thép (nhóm 87.10); (d) Kính ngắm hoặc thiết bị quang học khác phù hợp để sử dụng với vũ khí, trừ loại đã được lắp với súng cầm tay hoặc loại được thiết kế phù hợp và đi cùng với súng cầm tay (Chương 90); (e) Cung, tên, kiếm bịt đầu hoặc đồ chơi (Chương 95); hoặc (f) Bộ sưu tập hoặc đồ cổ (nhóm 97.05 hoặc 97.06).",
    ...
    generalVi: "Chương này bao gồm các loại vũ khí dùng cho tác chiến trên bộ, biển hay trên không do quân đội, cảnh sát hay các lực lượng khác sử dụng; các loại vũ khí được sử dụng bởi cá nhân với mục đích tự vệ, săn bắn, bắn bia; những khí cụ khác sử dụng sức nổ của thuốc súng; đạn và tên lửa.",
    generalEn: "This Chapter covers weapons used in warfare on land, sea or air by the armed forces, police or other forces; weapons used by individuals for self-defence, hunting, target practice; other devices using explosive powder; ammunition and missiles.",
    headings: [
      { code: "93.01", titleVi: "Vũ khí quân sự, trừ súng lục ổ quay, súng lục và các loại vũ khí thuộc nhóm 93.07", titleEn: "Military weapons, other than revolvers, pistols and the arms of heading 93.07", contentVi: "Nhóm này bao gồm vũ khí pháo binh (súng, súng cối), bệ phóng tên lửa, súng phun lửa, súng phóng lựu đạn, ống phóng ngư lôi, súng máy và súng trường quân sự.", contentEn: "This heading covers artillery weapons (guns, howitzers, mortars), rocket launchers, flame-throwers, grenade launchers, torpedo tubes, machine guns and military rifles." },
      { code: "93.02", titleVi: "Súng lục ổ quay và súng lục, trừ các loại thuộc nhóm 93.03 hoặc 93.04", titleEn: "Revolvers and pistols, other than those of heading 93.03 or 93.04", contentVi: "Nhóm này bao gồm súng lục ổ quay và súng lục các cỡ, có thể phóng ra một đầu đạn bằng sức nổ của một liều thuốc nổ và được chế tạo để cầm và bắn bằng tay.", contentEn: "This heading covers revolvers and pistols of all calibres capable of firing a projectile by the explosion of a propellant charge and designed to be held and fired by hand." },
      { code: "93.03", titleVi: "Súng cầm tay khác và các loại tương tự hoạt động bằng cách đốt cháy lượng thuốc nổ đã nạp", titleEn: "Other firearms and similar devices which operate by the firing of an explosive charge", contentVi: "Nhóm này bao gồm súng shotgun thể thao, súng trường thể thao, súng cầm tay nạp đạn phía nòng, súng bắn pháo hiệu, súng bắn gia súc giết mổ và súng phóng dây.", contentEn: "This heading covers sporting shotguns, sporting rifles, muzzle-loading firearms, signal pistols, captive-bolt humane killers and line-throwing guns." },
      { code: "93.04", titleVi: "Vũ khí khác (ví dụ, súng và súng lục sử dụng lò xo, hơi hoặc khí ga, dùi cui), trừ các loại thuộc nhóm 93.07", titleEn: "Other arms (for example, spring, air or gas guns and pistols, truncheons), excluding those of heading 93.07", contentVi: "Nhóm này bao gồm dùi cui, quả đấm sắt, súng cao su, súng hơi và súng lục sử dụng lò xo, hơi hoặc khí ga.", contentEn: "This heading covers truncheons, knuckle-dusters, catapults, spring guns and pistols, air guns and gas-operated pistols." },
      { code: "93.05", titleVi: "Bộ phận và phụ kiện của các loại vũ khí thuộc các nhóm từ 93.01 đến 93.04", titleEn: "Parts and accessories of articles of headings 93.01 to 93.04", contentVi: "Nhóm này bao gồm các bộ phận và phụ kiện của súng lục, súng shotgun, súng trường và vũ khí quân sự như nòng súng, báng súng, khóa nòng và kính ngắm.", contentEn: "This heading covers parts and accessories of revolvers, shotguns, rifles and military weapons such as barrels, stocks, bolts and telescopic sights." },
      { code: "93.06", titleVi: "Bom, lựu đạn, ngư lôi, mìn, tên lửa và các loại đạn tương tự và bộ phận của chúng; đạn dược các loại, đạn dùng cho súng săn và bộ phận của chúng", titleEn: "Bombs, grenades, torpedoes, mines, missiles, and similar munitions of war and parts thereof; cartridges and other ammunition and projectiles and parts thereof", contentVi: "Nhóm này bao gồm bom, lựu đạn, ngư lôi, mìn, tên lửa dẫn đường và không dẫn đường, đạn các loại và bộ phận của chúng.", contentEn: "This heading covers bombs, grenades, torpedoes, mines, guided and unguided missiles, cartridges of all kinds and parts thereof." },
      { code: "93.07", titleVi: "Kiếm, gươm, lưỡi lê, giáo mác và các loại vũ khí tương tự và bộ phận của chúng và vỏ bao của chúng", titleEn: "Swords, cutlasses, bayonets, lances and similar arms and parts thereof and scabbards and sheaths therefor", contentVi: "Nhóm này bao gồm kiếm, gươm, lưỡi lê, giáo mác và các loại vũ khí tương tự cùng với vỏ bao của chúng.", contentEn: "This heading covers swords, cutlasses, bayonets, lances and similar arms and their scabbards and sheaths." }
    ]
  },
  {
    chapter: 94,
    section: 20,
    sectionTitleVi: "CÁC MẶT HÀNG KHÁC",
    sectionTitleEn: "MISCELLANEOUS MANUFACTURED ARTICLES",
    titleVi: "Đồ nội thất; bộ đồ giường, đệm, khung đệm, nệm và các đồ dùng nhồi tương tự; đèn và bộ đèn; biển hiệu được chiếu sáng; nhà lắp ghép",
    titleEn: "Furniture; bedding, mattresses, mattress supports, cushions and similar stuffed furnishings; luminaires and lighting fittings; illuminated signs; prefabricated buildings",
    notesVi: [
      "1. Chương này không bao gồm: (a) Đệm, gối hoặc nệm, bằng hơi hoặc nước, thuộc Chương 39, 40 hoặc 63; (b) Gương được thiết kế để đặt trên sàn hoặc nền thuộc nhóm 70.09; (c) Các mặt hàng thuộc Chương 71; (d) Các bộ phận có công dụng chung bằng kim loại cơ bản (Phần XV), hoặc các loại hàng hóa tương tự bằng plastic (Chương 39), hoặc két an toàn thuộc nhóm 83.03; (e) Đồ nội thất được thiết kế đặc biệt như bộ phận của các thiết bị làm lạnh thuộc nhóm 84.18; (f) Đèn hoặc nguồn sáng và bộ phận của chúng thuộc Chương 85; (g) Đồ nội thất có tính chất đồ chơi hoặc đèn đồ chơi (nhóm 95.03).",
      ...
      "3. (A) Bộ phận của hàng hóa trong các nhóm từ 94.01 đến 94.03 không bao gồm các dạng tấm hoặc phiến bằng thủy tinh, bằng đá hoa hoặc đá khác thuộc Chương 68 hoặc 69. (B) Hàng hóa mô tả trong nhóm 94.04, dưới hình thức tách biệt, thì không phân loại như bộ phận của các hàng hóa trong nhóm 94.01, 94.02 hoặc 94.03.",
      "4. Theo mục đích của nhóm 94.06, khái niệm \"nhà lắp ghép\" có nghĩa là nhà đã hoàn chỉnh trong nhà máy hoặc đóng gói như các bộ phận nhà đi kèm với nhau, để lắp ghép tại chỗ."
    ],
    notesEn: [
      "1. This Chapter does not cover: (a) Pneumatic or water mattresses, pillows or cushions, of Chapter 39, 40 or 63; (b) Mirrors designed for placing on the floor or ground of heading 70.09; (c) Articles of Chapter 71; (d) Parts of general use of base metal (Section XV), or similar goods of plastics (Chapter 39), or safes of heading 83.03; (e) Furniture specially designed as parts of refrigerating equipment of heading 84.18; (f) Lamps or light sources and parts thereof of Chapter 85; (g) Toy furniture or toy luminaires (heading 95.03).",
      "2. Articles (other than parts) of headings 94.01 to 94.03 are to be classified in those headings only if they are designed for placing on the floor or ground.",
      "3. (A) Parts of goods of headings 94.01 to 94.03 do not include sheets or plates of glass, marble or other stone or of any other material covered by Chapter 68 or 69. (B) Goods described in heading 94.04, presented separately, are not to be classified as parts of goods of heading 94.01, 94.02 or 94.03.",
      "4. For the purposes of heading 94.06, the expression \"prefabricated buildings\" means buildings which are finished in the factory or put up as elements, presented together, to be assembled on site."
    ],
    generalVi: "Chương này bao gồm đồ nội thất các loại và bộ phận của chúng, khung đệm, đệm và các mặt hàng khác thuộc bộ đồ giường, đèn và các bộ đèn, biển hiệu được chiếu sáng và nhà lắp ghép.",
    generalEn: "This Chapter covers furniture of all kinds and parts thereof, mattress supports, mattresses and other bedding articles, luminaires and lighting fittings, illuminated signs and prefabricated buildings.",
    headings: [
      { code: "94.01", titleVi: "Ghế ngồi (trừ các loại thuộc nhóm 94.02), có hoặc không chuyển được thành giường, và bộ phận của chúng", titleEn: "Seats (other than those of heading 94.02), whether or not convertible into beds, and parts thereof", contentVi: "Nhóm này bao gồm ghế dùng cho phương tiện bay, ghế dùng cho xe có động cơ, ghế quay, ghế có thể chuyển thành giường, ghế bằng mây, tre, ghế có khung bằng gỗ hoặc kim loại.", contentEn: "This heading covers seats for aircraft, seats for motor vehicles, swivel seats, convertible seats, seats of cane, bamboo, seats with wooden or metal frames." },
      { code: "94.02", titleVi: "Đồ nội thất dùng trong y tế, phẫu thuật, nha khoa hoặc thú y; ghế cắt tóc và các loại ghế tương tự; bộ phận của chúng", titleEn: "Medical, surgical, dental or veterinary furniture; barbers' chairs and similar chairs; parts thereof", contentVi: "Nhóm này bao gồm bàn mổ, bàn khám bệnh, giường bệnh viện có thiết bị cơ khí, ghế nha khoa và ghế cắt tóc.", contentEn: "This heading covers operating tables, examination tables, hospital beds with mechanical fittings, dentists' chairs and barbers' chairs." },
      { code: "94.03", titleVi: "Đồ nội thất khác và bộ phận của chúng", titleEn: "Other furniture and parts thereof", contentVi: "Nhóm này bao gồm đồ nội thất văn phòng bằng kim loại, đồ nội thất bằng gỗ dùng trong văn phòng, nhà bếp, phòng ngủ và các đồ nội thất khác.", contentEn: "This heading covers metal office furniture, wooden furniture for offices, kitchens, bedrooms and other furniture." },
      { code: "94.04", titleVi: "Khung đệm; các mặt hàng thuộc bộ đồ giường và các đồ dùng tương tự có gắn lò xo hoặc nhồi hoặc lắp bên trong bằng vật liệu bất kỳ", titleEn: "Mattress supports; articles of bedding and similar furnishing fitted with springs or stuffed or internally fitted with any material", contentVi: "Nhóm này bao gồm khung đệm, đệm lò xo, đệm mút, gối, chăn bông, túi ngủ và nệm.", contentEn: "This heading covers mattress supports, spring mattresses, foam mattresses, pillows, quilts, sleeping bags and cushions." },
      { code: "94.05", titleVi: "Đèn và bộ đèn kể cả đèn pha, đèn rọi và các bộ phận của chúng; biển hiệu được chiếu sáng, biển đề tên được chiếu sáng và các loại tương tự", titleEn: "Luminaires and lighting fittings including searchlights and spotlights and parts thereof; illuminated signs, illuminated name-plates and the like", contentVi: "Nhóm này bao gồm đèn trần, đèn treo, đèn bàn, đèn sàn, đèn pha, đèn rọi và biển hiệu được chiếu sáng.", contentEn: "This heading covers chandeliers, ceiling lamps, table lamps, floor lamps, searchlights, spotlights and illuminated signs." },
      { code: "94.06", titleVi: "Nhà lắp ghép", titleEn: "Prefabricated buildings", contentVi: "Nhóm này bao gồm nhà lắp ghép bằng gỗ, bằng sắt hoặc thép, bằng nhôm hoặc bằng plastic, như nhà ở, văn phòng, trường học, lán trại và gara.", contentEn: "This heading covers prefabricated buildings of wood, iron or steel, aluminium or plastics, such as dwellings, offices, schools, shelters and garages." }
    ]
  },
  {
    chapter: 95,
    ...
    sectionTitleVi: "CÁC MẶT HÀNG KHÁC",
    sectionTitleEn: "MISCELLANEOUS MANUFACTURED ARTICLES",
    titleVi: "Đồ chơi, thiết bị trò chơi và dụng cụ thể thao; các bộ phận và phụ kiện của chúng",
    titleEn: "Toys, games and sports requisites; parts and accessories thereof",
    notesVi: [
      "1. Chương này không bao gồm: (a) Nến (nhóm 34.06); (b) Pháo hoa hoặc các sản phẩm pháo khác thuộc nhóm 36.04; (c) Sợi, sợi đơn, chỉ xe và dây gut hoặc các sản phẩm tương tự dùng trong câu cá, cắt theo chiều dài, của Chương 39, nhóm 42.06 hoặc Phần XI; (d) Túi thể thao hoặc các đồ chứa khác của nhóm 42.02, 43.03 hoặc 43.04; (e) Trang phục thể thao hoặc quần áo hóa trang, bằng vật liệu dệt, của Chương 61 hoặc 62; (f) Cờ hoặc băng thể thao bằng vật liệu dệt (Chương 63); (g) Xe đạp trẻ em (nhóm 87.12); (h) Phương tiện bay không người lái (nhóm 88.06).",
      "2. Chương này bao gồm cả các sản phẩm trong đó có ngọc trai thiên nhiên hoặc nuôi cấy, đá quý hoặc đá bán quý, kim loại quý hoặc kim loại dát phủ kim loại quý chỉ là thành phần thứ yếu.",
      ...
      "4. Nhóm 95.03 không bao gồm các mặt hàng mà, theo thiết kế, hình dáng hoặc vật liệu cấu thành, có thể xác định chúng chỉ được sử dụng riêng cho động vật.",
      "5. Theo nội dung của nhóm 95.08: (a) Khái niệm \"trò chơi di chuyển trong công viên giải trí\" có nghĩa là một thiết bị hoặc tổ hợp các thiết bị để mang, vận chuyển hoặc dẫn người đi trên hoặc đi qua một tuyến đường cố định cho mục đích vui chơi hoặc giải trí; (b) Khái niệm \"trò chơi công viên nước\" có nghĩa là một thiết bị có đặc trưng bởi một khu vực nước cụ thể; (c) Khái niệm \"trò chơi hội chợ\" có nghĩa là các trò chơi may mắn, sức mạnh hoặc kỹ năng."
    ],
    notesEn: [
      "1. This Chapter does not cover: (a) Candles (heading 34.06); (b) Fireworks or other pyrotechnic articles of heading 36.04; (c) Yarns, monofilament, cords and gut or the like for fishing, cut to length, of Chapter 39, heading 42.06 or Section XI; (d) Sports bags or other containers of heading 42.02, 43.03 or 43.04; (e) Sports clothing or fancy dress, of textiles, of Chapter 61 or 62; (f) Textile flags or bunting (Chapter 63); (g) Children's bicycles (heading 87.12); (h) Unmanned aircraft (heading 88.06).",
      "2. This Chapter includes articles in which natural or cultured pearls, precious or semi-precious stones, precious metal or metal clad with precious metal constitute only minor constituents.",
      ...
      "4. Heading 95.03 does not cover articles which are identifiable as intended exclusively for animals.",
      "5. For the purposes of heading 95.08: (a) \"amusement park rides\" means a device for carrying, conveying, or directing persons over or through a fixed route for amusement; (b) \"water park amusements\" means a device characterized by a defined area involving water; (c) \"fairground amusements\" means games of chance, strength or skill."
    ],
    generalVi: "Chương này bao gồm đồ chơi các loại được thiết kế để giải trí cho trẻ em hoặc người lớn, thiết bị trò chơi trong nhà hoặc ngoài trời, các thiết bị và dụng cụ dùng cho các môn thể thao, và các trò giải trí tại các hội chợ.",
    generalEn: "This Chapter covers toys of all kinds designed for the amusement of children or adults, indoor or outdoor games, sports equipment and apparatus, and fairground amusements.",
    headings: [
      { code: "95.03", titleVi: "Xe đạp ba bánh, xe đẩy, xe có bàn đạp và đồ chơi tương tự có bánh; xe của búp bê; búp bê; đồ chơi khác; mẫu thu nhỏ theo tỷ lệ và các mẫu đồ chơi giải trí tương tự; các loại đồ chơi đố trí", titleEn: "Tricycles, scooters, pedal cars and similar wheeled toys; dolls' carriages; dolls; other toys; reduced-size models and similar recreational models; puzzles of all kinds", contentVi: "Nhóm này bao gồm xe đạp ba bánh trẻ em, xe đẩy, xe bàn đạp, xe của búp bê, búp bê các loại, đồ chơi xây dựng, xe ô tô đồ chơi, nhà búp bê và các loại đồ chơi đố trí.", contentEn: "This heading covers children's tricycles, scooters, pedal cars, dolls' carriages, dolls, construction toys, toy cars, dolls' houses and puzzles of all kinds." },
      { code: "95.04", titleVi: "Bảng điều khiển và máy trò chơi video, các mặt hàng dùng cho trò chơi bàn và salon, kể cả bàn bắn bi, bàn bi-a các loại, các bàn đặc biệt dùng để chơi trò chơi ở sòng bạc và các thiết bị để đi đường bowling tự động", titleEn: "Video game consoles and machines, table and parlour games, including pintables, billiards, special tables for casino games and automatic bowling alley equipment", contentVi: "Nhóm này bao gồm máy trò chơi video, bàn bắn bi, bàn bi-a, bàn chơi bài, bàn cờ và thiết bị bowling tự động.", contentEn: "This heading covers video game machines, pintables, billiard tables, card tables, chess tables and automatic bowling alley equipment." },
      { code: "95.05", titleVi: "Các dụng cụ dùng cho lễ hội, lễ hội hóa trang hoặc các trò vui giải trí khác, kể cả các dụng cụ dùng trong ảo thuật và các trò trêu chọc", titleEn: "Festive, carnival or other entertainment articles, including conjuring tricks and novelty jokes", contentVi: "Nhóm này bao gồm đồ trang trí cây thông Noel, đồ dùng cho lễ hội hóa trang, mặt nạ, dụng cụ ảo thuật và các trò trêu chọc.", contentEn: "This heading covers Christmas tree decorations, carnival articles, masks, conjuring tricks and novelty jokes." },
      { code: "95.06", titleVi: "Các sản phẩm và thiết bị dùng cho các bài tập thể dục tổng hợp, thể dục dụng cụ, điền kinh, các môn thể thao khác (kể cả bóng bàn) hoặc các trò chơi ngoài trời", titleEn: "Articles and equipment for general physical exercise, gymnastics, athletics, other sports (including table-tennis) or outdoor games", contentVi: "Nhóm này bao gồm thiết bị tập thể dục, dụng cụ thể dục dụng cụ, bóng các loại, vợt, gậy gôn, ván trượt tuyết, ván trượt nước và dụng cụ câu cá.", contentEn: "This heading covers exercise equipment, gymnastics apparatus, balls of all kinds, rackets, golf clubs, skis, water-skis and fishing tackle." },
      { code: "95.07", titleVi: "Cần câu, lưỡi câu và các dụng cụ câu đường khác; vợt bắt cá, vợt bắt bướm và các loại vợt tương tự; chim giả để nhử và các loại mồi nhử tương tự và dụng cụ săn bắn hoặc bắn súng tương tự", titleEn: "Fishing rods, fish-hooks and other line fishing tackle; fish landing nets, butterfly nets and similar nets; decoy birds and similar hunting or shooting requisites", contentVi: "Nhóm này bao gồm cần câu, lưỡi câu, máy cuộn dây câu, vợt bắt cá, chim giả để nhử và dụng cụ săn bắn.", contentEn: "This heading covers fishing rods, fish-hooks, fishing reels, fish landing nets, decoy birds and hunting requisites." },
      { code: "95.08", titleVi: "Trò chơi di chuyển trong công viên giải trí, trò chơi công viên nước, trò chơi hội chợ, bao gồm trò bắn bia di động; rạp xiếc lưu động và bầy thú biểu diễn lưu động; nhà hát lưu động", titleEn: "Travelling circuses and travelling menageries; amusement park rides and water park amusements; fairground amusements, including shooting galleries; travelling theatres", contentVi: "Nhóm này bao gồm đu quay, tàu lượn siêu tốc, trò chơi công viên nước, trò bắn bia, rạp xiếc lưu động và nhà hát lưu động.", contentEn: "This heading covers carousels, roller coasters, water park amusements, shooting galleries, travelling circuses and travelling theatres." }
    ]
  },
  {
    chapter: 96,
    ...
    sectionTitleVi: "CÁC MẶT HÀNG KHÁC",
    sectionTitleEn: "MISCELLANEOUS MANUFACTURED ARTICLES",
    titleVi: "Các mặt hàng khác",
    titleEn: "Miscellaneous manufactured articles",
    notesVi: [
      "1. Chương này không bao gồm: (a) Bút chì dùng để trang điểm (Chương 33); (b) Các mặt hàng thuộc Chương 66 (ví dụ, các bộ phận của ô hoặc gậy chống); (c) Đồ trang sức làm bằng chất liệu khác (nhóm 71.17); (d) Các bộ phận có công dụng chung làm bằng kim loại cơ bản (Phần XV), hoặc các hàng hóa tương tự làm bằng plastic (Chương 39); (e) Dao kéo hoặc các mặt hàng khác thuộc Chương 82 có cán bằng vật liệu chạm khắc; (f) Các mặt hàng thuộc Chương 90; (g) Các mặt hàng thuộc Chương 91 (ví dụ, vỏ đồng hồ); (h) Nhạc cụ hoặc bộ phận của nhạc cụ (Chương 92); (ij) Các mặt hàng thuộc Chương 93 (vũ khí); (k) Các mặt hàng thuộc Chương 94 (đồ nội thất, đèn); (l) Các sản phẩm thuộc Chương 95 (đồ chơi, trò chơi, dụng cụ thể thao); hoặc (m) Tác phẩm nghệ thuật, đồ sưu tầm hoặc đồ cổ (Chương 97).",
      "2. Trong nhóm 96.02 khái niệm \"vật liệu chạm khắc có nguồn gốc thực vật hoặc khoáng chất\" có nghĩa là: (a) Hạt cứng, hột, vỏ quả và quả hạch và vật liệu từ thực vật tương tự dùng để chạm khắc; (b) Hổ phách, đá bọt, hổ phách và đá bọt kết tụ, hạt huyền và chất khoáng thay thế cho hạt huyền này.",
      "3. Trong nhóm 96.03 khái niệm \"túm và búi đã làm sẵn để làm chổi hoặc bàn chải\" chỉ bao gồm những túm và búi chưa được buộc bằng lông động vật, xơ thực vật hoặc vật liệu khác, đã chuẩn bị sẵn để bó.",
      "4. Các mặt hàng thuộc Chương này, trừ các nhóm từ 96.01 đến 96.06 hoặc 96.15, vẫn được phân loại vào Chương này dù có hoặc không chứa một phần hoặc toàn bộ kim loại quý, ngọc trai thiên nhiên hoặc nuôi cấy, hoặc đá quý hoặc đá bán quý."
    ],
    notesEn: [
      "1. This Chapter does not cover: (a) Pencils for cosmetic or toilet uses (Chapter 33); (b) Articles of Chapter 66 (parts of umbrellas or walking-sticks); (c) Imitation jewellery (heading 71.17); (d) Parts of general use of base metal (Section XV), or similar goods of plastics (Chapter 39); (e) Cutlery or other articles of Chapter 82 with handles of carving materials; (f) Articles of Chapter 90; (g) Articles of Chapter 91 (clock or watch cases); (h) Musical instruments or parts thereof (Chapter 92); (ij) Articles of Chapter 93 (arms); (k) Articles of Chapter 94 (furniture, luminaires); (l) Articles of Chapter 95 (toys, games, sports requisites); or (m) Works of art, collectors' pieces or antiques (Chapter 97).",
      "2. In heading 96.02, \"vegetable or mineral carving material\" means: (a) Hard seeds, pips, hulls and nuts and similar vegetable materials for carving; (b) Amber, meerschaum, agglomerated amber and meerschaum, jet and mineral substitutes for jet.",
      "3. In heading 96.03, \"prepared knots and tufts for broom or brush making\" applies only to unmounted knots and tufts of animal hair, vegetable fibre or other material, ready for incorporation in brooms or brushes.",
      "4. Articles of this Chapter, other than headings 96.01 to 96.06 or 96.15, remain classified in this Chapter whether or not composed wholly or partly of precious metal, natural or cultured pearls, or precious or semi-precious stones."
    ],
    generalVi: "Chương này bao gồm các vật liệu để chạm trổ và để đúc và các sản phẩm làm từ chúng, một số mặt hàng chổi, bàn chải và rây sàng, đồ may vá, văn phòng phẩm, dụng cụ cho người hút thuốc, đồ dùng nhà vệ sinh, một số sản phẩm vệ sinh thấm nước và các vật dụng khác.",
    generalEn: "This Chapter covers carving and moulding materials and articles thereof, certain brooms, brushes and sieves, articles of haberdashery, writing and office equipment, smokers' requisites, toilet articles, certain sanitary absorbent products and various other articles.",
    headings: [
      { code: "96.01", titleVi: "Ngà, xương, đồi mồi, sừng, nhánh gạc, san hô, xà cừ và các vật liệu chạm khắc có nguồn gốc động vật khác đã gia công, và các mặt hàng làm từ các vật liệu này", titleEn: "Worked ivory, bone, tortoise-shell, horn, antlers, coral, mother-of-pearl and other animal carving material, and articles of these materials", contentVi: "Nhóm này bao gồm ngà đã gia công và các vật phẩm bằng ngà, xương, đồi mồi, sừng, gạc, san hô và xà cừ đã gia công.", contentEn: "This heading covers worked ivory and articles of ivory, bone, tortoise-shell, horn, antlers, coral and mother-of-pearl." },
      { code: "96.02", titleVi: "Vật liệu chạm khắc có nguồn gốc thực vật hoặc khoáng chất đã gia công, và các mặt hàng làm từ các vật liệu này; các mặt hàng đúc hoặc chạm khắc từ sáp, parafin, stearin, keo hoặc nhựa tự nhiên, bột nhão đúc", titleEn: "Worked vegetable or mineral carving material and articles of these materials; moulded or carved articles of wax, stearin, natural gums or resins or modelling pastes", contentVi: "Nhóm này bao gồm các vật liệu chạm khắc có nguồn gốc thực vật hoặc khoáng chất đã gia công như hổ phách, đá bọt và hạt huyền.", contentEn: "This heading covers worked vegetable or mineral carving materials such as amber, meerschaum and jet." },
      { code: "96.03", titleVi: "Chổi và bàn chải, kể cả bàn chải là các bộ phận của máy, thiết bị hoặc xe; chổi cơ khí để quét sàn, loại không có động cơ; cây lăn sơn; thanh cao su hoặc vật liệu mềm dẻo tương tự dùng để gạt nước", titleEn: "Brooms, brushes, including brushes constituting parts of machines; hand-operated mechanical floor sweepers; mops and feather dusters; prepared knots and tufts for broom or brush making; paint pads and rollers; squeegees", contentVi: "Nhóm này bao gồm chổi quét nhà, chổi quét lông, bàn chải đánh răng, bàn chải cho máy, cây lau sàn, cây lăn sơn và thanh gạt nước.", contentEn: "This heading covers brooms, feather dusters, toothbrushes, machine brushes, mops, paint rollers and squeegees." },
      { code: "96.04", titleVi: "Sàng, rây bằng tay", titleEn: "Hand sieves and hand riddles", contentVi: "Nhóm này bao gồm sàng và rây bằng tay làm từ các vật liệu khác nhau.", contentEn: "This heading covers hand sieves and hand riddles made of various materials." },
      { code: "96.05", titleVi: "Bộ đồ du lịch dùng cho vệ sinh cá nhân, may vá hoặc dùng để làm sạch giày hoặc quần áo", titleEn: "Travel sets for personal toilet, sewing or shoe or clothes cleaning", contentVi: "Nhóm này bao gồm bộ đồ du lịch dùng cho vệ sinh cá nhân, bộ đồ may vá và bộ đồ làm sạch giày hoặc quần áo.", contentEn: "This heading covers travel sets for personal toilet, sewing kits and shoe or clothes cleaning sets." },
      { code: "96.06", titleVi: "Cúc, cúc bấm, cúc gài hình đĩa và các bộ phận của các loại cúc này; cúc chưa hoàn chỉnh; khoanh cúc", titleEn: "Buttons, press-fasteners, snap-fasteners and press-studs, button moulds and other parts of these articles; button blanks", contentVi: "Nhóm này bao gồm cúc các loại bằng plastic, kim loại, ngọc trai hoặc các vật liệu khác, cúc bấm, cúc gài và khoanh cúc.", contentEn: "This heading covers buttons of all kinds of plastics, metal, mother-of-pearl or other materials, press-fasteners, snap-fasteners and button blanks." },
      { code: "96.07", titleVi: "Khóa kéo và các bộ phận của khóa kéo", titleEn: "Slide fasteners and parts thereof", contentVi: "Nhóm này bao gồm khóa kéo kim loại, khóa kéo bằng plastic và các bộ phận của khóa kéo như răng, đầu kéo.", contentEn: "This heading covers metal slide fasteners, plastic slide fasteners and parts thereof such as teeth and sliders." },
      { code: "96.08", titleVi: "Bút bi; bút phớt và bút đánh dấu đầu xốp hoặc đầu bằng vật liệu sợi; bút máy, bút mực kiểu lập-sơ và các loại bút khác; bút sao chép; bút chì bấm hoặc bút chì đẩy", titleEn: "Ball point pens; felt tipped and other porous-tipped pens and markers; fountain pens, stylograph pens and other pens; duplicating stylos; propelling or sliding pencils", contentVi: "Nhóm này bao gồm bút bi, bút phớt, bút đánh dấu, bút máy, bút mực và bút chì bấm.", contentEn: "This heading covers ball point pens, felt tipped pens, markers, fountain pens, stylograph pens and propelling pencils." },
      { code: "96.09", titleVi: "Bút chì (trừ các loại bút thuộc nhóm 96.08), chì màu, lõi bút chì, phấn vẽ, than vẽ, phấn viết hoặc vẽ và phấn may", titleEn: "Pencils (other than pencils of heading 96.08), crayons, pencil leads, pastels, drawing charcoals, writing or drawing chalks and tailors' chalks", contentVi: "Nhóm này bao gồm bút chì, chì màu, lõi bút chì, phấn vẽ, than vẽ và phấn may.", contentEn: "This heading covers pencils, crayons, pencil leads, pastels, drawing charcoals and tailors' chalks." },
      { code: "96.10", titleVi: "Bảng đen và bảng trắng có bề mặt để viết hoặc vẽ, có hoặc không có khung", titleEn: "Slates and boards, with writing or drawing surfaces, whether or not framed", contentVi: "Nhóm này bao gồm bảng đen và bảng trắng có bề mặt để viết hoặc vẽ.", contentEn: "This heading covers slates and boards with writing or drawing surfaces." },
      { code: "96.11", titleVi: "Con dấu ngày tháng, con dấu niêm phong hoặc đánh số, và các loại tương tự; thiết bị dùng để in hoặc dập nổi nhãn, hoạt động bằng tay", titleEn: "Date, sealing or numbering stamps, and the like; hand-operated devices for printing or embossing labels", contentVi: "Nhóm này bao gồm con dấu ngày tháng, con dấu niêm phong, con dấu đánh số và thiết bị in nhãn bằng tay.", contentEn: "This heading covers date stamps, sealing stamps, numbering stamps and hand-operated labelling devices." },
      { code: "96.12", titleVi: "Băng máy chữ và các loại băng tương tự, đã thấm mực hoặc xử lý cách khác để in ấn, có hoặc không có cuộn hoặc có hộp; miếng thấm mực", titleEn: "Typewriter or similar ribbons, inked or otherwise prepared for giving impressions, whether or not on spools or in cartridges; ink-pads", contentVi: "Nhóm này bao gồm băng máy chữ, băng máy in và miếng thấm mực.", contentEn: "This heading covers typewriter ribbons, printer ribbons and ink-pads." },
      { code: "96.13", titleVi: "Bật lửa thuốc lá và các loại bật lửa khác, có hoặc không có cơ khí hoặc điện, và các bộ phận của chúng trừ đá lửa và bấc", titleEn: "Cigarette lighters and other lighters, whether or not mechanical or electrical, and parts thereof other than flints and wicks", contentVi: "Nhóm này bao gồm bật lửa ga, bật lửa điện và các bộ phận của bật lửa.", contentEn: "This heading covers gas lighters, electric lighters and parts of lighters." },
      { code: "96.14", titleVi: "Tẩu thuốc (kể cả đầu tẩu), giá ống xì gà và giá ống thuốc lá, và bộ phận của chúng", titleEn: "Smoking pipes (including pipe bowls) and cigar or cigarette holders, and parts thereof", contentVi: "Nhóm này bao gồm tẩu thuốc, đầu tẩu, giá ống xì gà và giá ống thuốc lá.", contentEn: "This heading covers smoking pipes, pipe bowls, cigar holders and cigarette holders." },
      { code: "96.15", titleVi: "Lược, trâm cài tóc và các loại tương tự; kẹp tóc, cuộn tóc, lô uốn tóc và các loại tương tự, trừ các loại thuộc nhóm 85.16, và các bộ phận của chúng", titleEn: "Combs, hair-slides and the like; hairpins, curling pins, curling grips, hair-curlers and the like, other than those of heading 85.16, and parts thereof", contentVi: "Nhóm này bao gồm lược, trâm cài tóc, kẹp tóc, lô uốn tóc và các bộ phận của chúng.", contentEn: "This heading covers combs, hair-slides, hairpins, curling pins and hair-curlers." },
      { code: "96.16", titleVi: "Bình xịt nước hoa và các loại bình xịt phấn trang điểm tương tự; các loại bông phấn và miếng gắn dùng để trang điểm hay vệ sinh cá nhân", titleEn: "Scent sprayers and similar toilet sprayers, and mounts and heads therefor; powder-puffs and pads for the application of cosmetics or toilet preparations", contentVi: "Nhóm này bao gồm bình xịt nước hoa, bông phấn và miếng gắn dùng để trang điểm.", contentEn: "This heading covers scent sprayers, powder-puffs and pads for cosmetics." },
      { code: "96.17", titleVi: "Phích đựng đồ uống và các đồ chứa chân không khác, hoàn chỉnh; bộ phận của chúng trừ vỏ thủy tinh", titleEn: "Vacuum flasks and other vacuum vessels, complete; parts thereof other than glass inners", contentVi: "Nhóm này bao gồm phích đựng đồ uống và các đồ chứa chân không khác.", contentEn: "This heading covers vacuum flasks and other vacuum vessels." },
      { code: "96.18", titleVi: "Ma-nơ-canh dùng cho người may đo và các mô hình tự động và các vật trưng bày cử động được khác dùng trong cửa hàng may mặc", titleEn: "Tailors' dummies and other lay figures; automata and other animated displays used for shop window dressing", contentVi: "Nhóm này bao gồm ma-nơ-canh và các mô hình tự động dùng trong cửa hàng may mặc.", contentEn: "This heading covers tailors' dummies and animated displays for shop windows." },
      { code: "96.19", titleVi: "Băng (miếng) và nút bông vệ sinh, tã lót và khăn lót cho trẻ và các mặt hàng tương tự, bằng vật liệu bất kỳ", titleEn: "Sanitary towels (pads) and tampons, napkins and napkin liners for babies and similar articles, of any material", contentVi: "Nhóm này bao gồm băng vệ sinh, nút bông vệ sinh, tã lót cho trẻ em và các mặt hàng vệ sinh tương tự.", contentEn: "This heading covers sanitary towels, tampons, baby napkins and similar sanitary articles." },
      { code: "96.20", titleVi: "Chân đế loại một chân (monopod), hai chân (bipod), ba chân (tripod) và các mặt hàng tương tự", titleEn: "Monopods, bipods, tripods and similar articles", contentVi: "Nhóm này bao gồm chân đế loại một chân, hai chân, ba chân và các mặt hàng tương tự dùng cho máy ảnh, đèn hoặc các thiết bị khác.", contentEn: "This heading covers monopods, bipods, tripods and similar articles for cameras, lamps or other equipment." }
    ]
  },
  {
    chapter: 97,
    section: 21,
    sectionTitleVi: "CÁC TÁC PHẨM NGHỆ THUẬT, ĐỒ SƯU TẦM VÀ ĐỒ CỔ",
    sectionTitleEn: "WORKS OF ART, COLLECTORS' PIECES AND ANTIQUES",
    titleVi: "Các tác phẩm nghệ thuật, đồ sưu tầm và đồ cổ",
    titleEn: "Works of art, collectors' pieces and antiques",
    notesVi: [
      "1. Chương này không bao gồm: (a) Tem bưu chính hoặc tem thuế chưa sử dụng, bưu thiếp (đã đóng sẵn tem) hoặc loại tương tự, thuộc nhóm 49.07; (b) Phông sân khấu, phông trường quay hoặc loại tương tự, bằng vải bạt đã sơn vẽ (nhóm 59.07) trừ khi chúng có thể phân loại được vào nhóm 97.06; hoặc (c) Ngọc trai, tự nhiên hoặc nuôi cấy, hoặc đá quý hoặc đá bán quý (thuộc các nhóm từ 71.01 đến 71.03).",
      ...
      "5. (A) Theo các Chú giải từ 1 đến 4 nêu trên, các mặt hàng thuộc Chương này phải được phân loại vào Chương này và không được phân loại vào bất kỳ Chương nào khác của Danh mục. (B) Nhóm 97.06 không áp dụng cho những mặt hàng thuộc các nhóm trên đây của Chương này.",
      "6. Khung của các bức tranh vẽ, tranh phác hoạ, tranh bột màu, hình ghép nghệ thuật hoặc phù điêu trang trí tương tự, bản khắc, bản in hoặc bản in lytô được phân loại cùng với các vật phẩm này, với điều kiện là chúng cùng chủng loại và có giá trị tương ứng với các mặt hàng này."
    ],
    notesEn: [
      "1. This Chapter does not cover: (a) Unused postage or revenue stamps, postal stationery (stamped paper) or the like, of heading 49.07; (b) Theatrical scenery, studio back-cloths or the like, of painted canvas (heading 59.07) except if they may be classified in heading 97.06; or (c) Pearls, natural or cultured, or precious or semi-precious stones (headings 71.01 to 71.03).",
      ...
      "5. (A) Subject to Notes 1 to 3 above, articles of this Chapter are to be classified in this Chapter and not in any other Chapter of the Nomenclature. (B) Heading 97.06 does not apply to articles of the preceding headings of this Chapter.",
    ...
    generalVi: "Chương này bao gồm: (A) Một số loại tác phẩm nghệ thuật nhất định: tranh vẽ, bản vẽ và tranh bột màu, thể hiện hoàn toàn bằng tay, và các tác phẩm ghép nghệ thuật và bức phù điêu trang trí tương tự (nhóm 97.01); các nguyên bản khắc, bản in, bản in li tô (nhóm 97.02); các nguyên bản tác phẩm điêu khắc và tượng tạc (nhóm 97.03). (B) Tem bưu điện, tem thuế và các loại tem tương tự, dấu tem bưu điện, phong bì có tem đóng dấu ngày phát hành đầu tiên, các ấn phẩm bưu chính (ấn phẩm đóng dấu tem) và các vật phẩm tương tự đã sử dụng hoặc chưa, ngoại trừ những loại thuộc nhóm 49.07 (nhóm 97.04). (C) Bộ sưu tập và đồ sưu tầm về động vật học, thực vật học, khoáng vật học, giải phẫu học, lịch sử, khảo cổ học, cổ sinh vật học, dân tộc học, bộ sưu tập tiền cổ (nhóm 97.05). (D) Đồ cổ có tuổi hơn 100 năm (nhóm 97.06).",
    generalEn: "This Chapter covers: (A) Certain works of art: paintings, drawings and pastels, executed entirely by hand, and collages, mosaics and similar decorative plaques (heading 97.01); original engravings, prints and lithographs (heading 97.02); original sculptures and statuary (heading 97.03). (B) Postage or revenue and similar stamps, stamp-postmarks, first-day covers, postal stationery (stamped paper) and the like, used or unused, other than those of heading 49.07 (heading 97.04). (C) Collections and collectors' pieces of zoological, botanical, mineralogical, anatomical, historical, archaeological, palaeontological, ethnographic or numismatic interest (heading 97.05). (D) Antiques of an age exceeding 100 years (heading 97.06).",
    headings: [
      { code: "97.01", titleVi: "Tranh vẽ, tranh phác họa và tranh bột màu, được vẽ hoàn toàn bằng tay, trừ các loại tranh phác họa thuộc nhóm 49.06 và trừ các tác phẩm vẽ hoặc trang trí bằng tay; các tác phẩm ghép và phù điêu trang trí tương tự", titleEn: "Paintings, drawings and pastels, executed entirely by hand, other than drawings of heading 49.06 and other than hand-painted or hand-decorated manufactured articles; collages, mosaics and similar decorative plaques", contentVi: "Nhóm này bao gồm các tranh vẽ, bản vẽ và tranh bột màu (dù là tranh cổ hay hiện đại), được thực hiện hoàn toàn bằng tay. Các tác phẩm này có thể là tranh sơn dầu, sáp màu, keo màu, tranh acrylic, tranh màu nước, tranh bột màu nước, tranh bột màu, bản vẽ thu nhỏ, bản vẽ tay có dạ quang, bản vẽ chì, bản vẽ than hoặc bản vẽ bút sắt... được thể hiện trên bất cứ chất liệu nào. Nhóm này cũng bao gồm các tác phẩm hình ghép nghệ thuật và phù điêu trang trí tương tự, gồm các mảnh nhỏ làm từ chất liệu động vật, thực vật hoặc chất liệu khác, được lắp ráp để tạo thành một bức tranh hoặc mẫu thiết kế.", contentEn: "This heading covers paintings, drawings and pastels (whether ancient or modern), executed entirely by hand. These works may take the form of oil paintings, wax paintings, tempera paintings, acrylic paintings, water-colours, gouache paintings, pastels, miniatures, illuminated manuscripts, pencil drawings, charcoal or pen drawings, etc., executed on any material. This heading also covers collages and similar decorative plaques, consisting of bits and pieces of various animal, vegetable or other materials, assembled so as to form a picture or decorative design." },
      { code: "97.02", titleVi: "Nguyên bản các bản khắc, bản in và bản in lytô", titleEn: "Original engravings, prints and lithographs", contentVi: "Nhóm này bao gồm các nguyên bản của bản khắc, bản in và bản in lyto (cổ điển hoặc hiện đại), ví dụ, các bản in trực tiếp, đen trắng hoặc màu, từ một hoặc nhiều bản gốc được tác giả thực hiện hoàn toàn bằng tay, không phụ thuộc vào quy trình làm và vật liệu chế tạo của tác giả đó, nhưng loại trừ các quy trình cơ khí hoặc quang cơ. Các nguyên bản in vẫn thuộc nhóm này, ngay cả khi chúng được sửa sang lại.", contentEn: "This heading covers original engravings, prints and lithographs (whether ancient or modern), i.e., impressions produced directly, in black and white or in colour, from one or several plates wholly executed by hand by the artist, irrespective of the process or of the material employed by him, but excluding any mechanical or photomechanical process. Original impressions remain in this heading even if they have been retouched." },
      { code: "97.03", titleVi: "Nguyên bản tác phẩm điêu khắc và tượng tạc, làm bằng mọi loại vật liệu", titleEn: "Original sculptures and statuary, in any material", contentVi: "Nhóm này bao gồm các tác phẩm điêu khắc, tượng, cổ điển hoặc hiện đại. Chúng có thể được làm bằng bất cứ chất liệu nào (đá, đá hoàn nguyên, đất nung, gỗ, ngà, kim loại, sáp...), dưới dạng hình tròn, chạm chìm hoặc chạm nổi. Nhóm này bao gồm không chỉ các mẫu gốc do nhà điêu khắc tạo ra mà còn cả bản sao, bản chụp các đồ vật đó. Nhóm này loại trừ các tác phẩm điêu khắc mang tính chất thương mại và các bản sao sản xuất hàng loạt.", contentEn: "This heading covers sculptures and statuary, whether ancient or modern. They may be made of any material (stone, reconstituted stone, terracotta, wood, ivory, metal, wax, etc.), in the round, in intaglio or in relief. The heading includes not only original models made by the sculptor but also copies and reproductions. The heading excludes sculptures of a commercial character and mass-produced reproductions." },
      { code: "97.04", titleVi: "Tem bưu chính hoặc tem thuế, dấu tem bưu điện, phong bì có tem đóng dấu ngày phát hành đầu tiên, các ấn phẩm bưu chính (ấn phẩm có in sẵn tem), và các ấn phẩm tương tự, đã hoặc chưa sử dụng, trừ loại thuộc nhóm 49.07", titleEn: "Postage or revenue stamps, stamp-postmarks, first-day covers, postal stationery (stamped paper), and the like, used or unused, other than those of heading 49.07", contentVi: "Nhóm này bao gồm: (A) Tem bưu điện các loại, tức là tem thông thường dùng để dán lên thư tín hoặc bưu phẩm, tem cước phí bưu điện, v.v. (B) Tem thuế các loại, tức là tem dán lên trên giấy biên nhận, tem đăng ký, tem cho phép lưu hành, tem lãnh sự, băng thu thuế có đóng dấu. (C) Dấu tem bưu điện: tức là thư mang dấu bưu điện không cần tem. (D) Tem dán trên phong bì hoặc bưu thiếp, bao gồm cả phong bì dán một hoặc một bộ tem kỷ niệm ngày phát hành đầu tiên. (E) Ấn phẩm bưu điện (giấy đóng sẵn tem bưu điện) tức là phong bì, thiếp thư, bưu thiếp, giải băng bọc báo... có đóng dấu miễn cước phí.", contentEn: "This heading covers: (A) Postage stamps of all kinds, i.e., ordinary stamps for affixing to letters or packages, \"postage due\" stamps, etc. (B) Revenue stamps of all kinds, i.e., stamps affixed to receipts, registration stamps, consular stamps, fiscally stamped bands, etc. (C) Stamp-postmarks, i.e., letters bearing postal obliteration without stamps. (D) First-day covers, i.e., envelopes or cards bearing stamps cancelled on the first day of issue. (E) Postal stationery (stamped paper), i.e., envelopes, letter-cards, postcards, newspaper bands, etc., with impressed stamps." },
      { code: "97.05", titleVi: "Bộ sưu tập và các vật phẩm sưu tập chủng loại khảo cổ, dân tộc học, sử học, động vật, thực vật, khoáng vật, giải phẫu học, cổ sinh vật học hoặc các loại tiền", titleEn: "Collections and collectors' pieces of zoological, botanical, mineralogical, anatomical, historical, archaeological, palaeontological, ethnographic or numismatic interest", contentVi: "Các đồ vật này thường ít có giá trị thực nhưng lại hấp dẫn vì sự hiếm hoi của chúng, vì nhóm của chúng hoặc vì hình thức của chúng. Nhóm này bao gồm: (A) Bộ sưu tập và các vật phẩm sưu tập có giá trị khảo cổ, dân tộc học hoặc lịch sử. (B) Bộ sưu tập và các vật phẩm sưu tập có giá trị về động vật, thực vật, khoáng vật, giải phẫu học hoặc cổ sinh vật học, bao gồm động vật chết, trứng, côn trùng, vỏ sò, hạt và cây phơi khô, các khoáng chất, hoá thạch, các mẫu vật khoa xương và giải phẫu. (C) Bộ sưu tập và các mẫu vật của người sưu tập tiền cổ, bao gồm các đồng tiền xu, tiền giấy không còn giá trị pháp lý và huy chương.", contentEn: "These articles usually have little intrinsic value but attract interest on account of their rarity, their grouping or their presentation. This heading covers: (A) Collections and collectors' pieces of archaeological, ethnographic or historical interest. (B) Collections and collectors' pieces of zoological, botanical, mineralogical, anatomical or palaeontological interest, including dead animals, eggs, insects, shells, dried seeds and plants, minerals, fossils, skeletal and anatomical specimens. (C) Collections and collectors' pieces of numismatic interest, including coins, banknotes no longer legal tender and medals." },
      { code: "97.06", titleVi: "Đồ cổ có tuổi trên 100 năm", titleEn: "Antiques of an age exceeding 100 years", contentVi: "Nhóm này bao gồm mọi đồ vật cổ có hơn 100 năm tuổi, với điều kiện chúng không thuộc vào nhóm 97.01 đến 97.05. Sức hấp dẫn của các đồ vật này do tuổi của chúng, dẫn tới sự khan hiếm của chúng. Nhóm này bao gồm: đồ đạc, khung và panen cổ; các sản phẩm của công nghiệp in (sách in cổ, âm nhạc, bản đồ, bản khắc); bình và các đồ vật bằng sứ; các sản phẩm dệt (thảm, hàng thêu, đăng ten); các đồ kim hoàn; các sản phẩm của thợ vàng hoặc thợ bạc; cửa kính màu; đèn chùm; nhạc cụ; đồng hồ các loại; tác phẩm nghệ thuật chạm đá quý.", contentEn: "This heading covers all antiques of an age exceeding one hundred years, provided they are not included in headings 97.01 to 97.05. The interest of these articles derives from their age and, as a general consequence, their resulting rarity. This heading includes: antique furniture, frames and panelling; products of the printing industry (incunabula and other books, music, maps, engravings); vases and other ceramic articles; textile articles (carpets, tapestries, embroidery, lace); jewellery; articles of goldsmiths' or silversmiths' wares; leaded or stained glass windows; chandeliers and lamps; musical instruments; clocks and watches; glyptographers' wares." }
    ]
  }
];
...
export const getSectionNote = (section: number): { vi: string; en: string } => {
  if (section === 1) {
    ...
    return {
      vi: "Phần này bao gồm các tác phẩm nghệ thuật, đồ sưu tầm và đồ cổ, bao gồm tranh vẽ, bản khắc, tác phẩm điêu khắc, tem bưu chính, bộ sưu tập và đồ cổ có tuổi trên 100 năm.",
      en: "This Section covers works of art, collectors' pieces and antiques, including paintings, engravings, sculptures, postage stamps, collections and antiques of an age exceeding 100 years."
    };
  }
  return { vi: "", en: "" };
};
