...
import { chapterFullDetailData } from "@/data/AllchapterFullDetailData";
import { senNoteDetailData } from "@/data/senNoteDetailData";
import { SearchLanguage, SearchMatchType } from "@/data/hsData";
