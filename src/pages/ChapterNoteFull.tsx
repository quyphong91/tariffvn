...
import { getChapterFullDetail, NoteRow } from "@/data/chapterFullDetailData";
...
const ChapterNoteFull = () => {
  ...
  const chapterData = getChapterFullDetail(chapter);
  ...
  const renderRow = (row: NoteRow, index: number, lang: 'vi' | 'en') => {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Chú giải song ngữ Việt - Anh đầy đủ cho Chương ${chapter} trong Danh mục HS Code.`}
        />
      </Helmet>
      ...
      <main className="mx-auto px-2 md:px-4 py-8">
        ...
        <div className="mb-6">
          ...
          <Link to="/chu-giai-hs" className="text-sm text-muted-foreground hover:text-primary transition-colors">
            Chú giải phân loại
          </Link>
          <span className="mx-2 text-muted-foreground">/</span>
        ...
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">
            Bilingual Explanatory Notes / Chú giải song ngữ Việt - Anh
          </p>
        </div>
        ...
        {chapterData ? (
          <div>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-0 rounded-xl border border-border overflow-hidden bg-card">
              ...
              <div className="bg-ocean text-white px-4 py-3 font-semibold text-center">
                English (EN)
              </div>
            ...
            <div className="md:hidden rounded-xl border border-border overflow-hidden bg-card">
              ...
              <div className={cn(
                ...
                mobileView === 'vi' ? "bg-primary" : "bg-ocean"
              )}>
          ...
          <div>
            <div className="p-8 rounded-xl border border-border bg-card text-center">
              ...
              <p className="text-muted-foreground mt-2">
                Detailed notes for Chapter {chapter} are being updated...
              </p>
            </div>
          </div>
          )}
